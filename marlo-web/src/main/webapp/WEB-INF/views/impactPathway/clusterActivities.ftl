  ...
  <div id="keyOutput-${isTemplate?string('template',(element.id)!)}" class="keyOutputItem expandableBlock borderBox"  style="display:${isTemplate?string('none','block')}">
    ...
    <div class="blockContent" style="display:none">
      ...
      <div class="form-group col-md-12">
        [@customForm.select name="" label=""  i18nkey="Select to add a outcome" listName="outcomes" keyFieldName="id"  displayFieldName="description"  multiple=false required=true  className=" outcomeList" disabled=!editable/]
      </div>
    </div>
