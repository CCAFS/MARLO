      ...
      <div class="col-md-9">
        ...
        [#if complete]
          ...
          <div class="fullPartBlock">
            ...
            <a href="[@s.url namespace="/projects" action='${(crpSession)!}/reportingSummary'][@s.param name='cycle']${cycleName}[/@s.param][@s.param name='projectID']${project.id?c}[/@s.param][/@s.url]" class="button-pdf-format" target="__BLANK">PDF Format</a> 
