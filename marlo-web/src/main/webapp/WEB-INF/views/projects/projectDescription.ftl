          ...
          <div id="projectDescription" class="borderBox">
              ...
              <div class="fullBlock">
                ...
                <div class="halfPartBlock">
                  [@customForm.select name="project.liaisonInstitution.id" disabled=!editable  listName="liaisonInstitutions" keyFieldName="id"  displayFieldName="composedName" required=true editable=editable /]
    
                </div>
                [#--  Project Owner Contact Person --]
                <div class="halfPartBlock">
                  [@customForm.select name="project.liaisonUser.id" listName="allOwners" keyFieldName="id"  displayFieldName="composedName" required=true editable=editable /]
