  ...
  <article class="fullBlock" id="mainInformation">
    ...
    <div class="buttons">
      <div class="buttons-content">
        [#if action.canAddFunding() && (!crpClosed)]<a class="addButton" href="[@s.url namespace="/fundingSources" action='${(crpSession)!}/{crp}/addNewFundingSources' ][/@s.url]">Add Funding Source</a>[/#if]
        <div class="clearfix"></div>
      </div>
    </div>
