      ...
      <div class="col-md-9">
        ...
        <div class="borderBox ">
          ...
          <div class="items-list">
            <ul>
            [#list locElementTypeList as targetUnit]
              [@targetUnitMacro element=targetUnit name="locElementTypeList" index=targetUnit_index /]
            [/#list]
            </ul>
          ...
          <div class="row ">
            ...
            <div class="col-md-3 text-right"><div class="addTargetUnit button-blue"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> [@s.text name="form.buttons.addLocationLevel" /]</div></div>
          </div>
        </div>
...
[@targetUnitMacro element={} name="locElementTypeList" index=-1 isTemplate=true canDelete=true /]
