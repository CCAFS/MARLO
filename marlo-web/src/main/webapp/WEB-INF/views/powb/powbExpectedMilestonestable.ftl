...
[#assign currentStage = "expectedMilestonestable" /]

[#assign breadCrumb = [
  {"label":"${currentSection}", "nameSpace":"", "action":""},
  {"label":"powbReport", "nameSpace":"powb", "action":"${crpSession}/delivery"},
  {"label":"powbExpectedMilestonestable", "nameSpace":"powb", "action":"${crpSession}/expectedMilestonestable"}
]/]
...
[#-- Helptext --]
[@utilities.helpBox name="powbExpectedMilestonestable.help" /]
  ...
  <div class="row">
    ...
    <div class="col-md-9">
      ...
      [@s.form action=actionName method="POST" enctype="multipart/form-data" cssClass=""]
        ...
        [#-- Title --]
        <h3 class="headTitle">[@s.text name="powbExpectedMilestonestable.title" /]</h3>
        <div class="borderBox">
