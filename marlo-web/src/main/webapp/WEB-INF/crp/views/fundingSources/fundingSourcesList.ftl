          ...
          <div  class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="row form-group">
                  <div class="col-md-6">
                    [@customForm.select name="budgetType" i18nkey="fundingSourcesList.add.budgetType" className="budgetType"  listName="budgetTypes" keyFieldName=""  displayFieldName="" required=true editable=true /]
                  </div>
                  <div class="col-md-6">
