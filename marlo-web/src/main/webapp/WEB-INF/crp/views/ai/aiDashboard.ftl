  ...
  <div class="row">
    <div class="col-md-12">
      ...
      [@s.form action=actionName method="POST" cssClass=""]
        ...
        <div id="projectDescription" class="borderBox" style="height; display: flex; align-items: center; border-radius: 8px;">        
          <br/>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 col-lg-10 col-xl-8 ">
            ...
            <div class="clearfix"></div>
						...
						<div class="simpleBox" style="border-radius: 8px;">
						  <p style="margin-top: 12px;">🧾 <strong>AICCRA Report Generator</strong></p>
						...
						<div class="simpleBox" style="margin-top: 15px; border-radius: 8px;">
						  <p style="margin-top: 12px;">💬 <strong>AICCRA Chatbot</strong></p>
