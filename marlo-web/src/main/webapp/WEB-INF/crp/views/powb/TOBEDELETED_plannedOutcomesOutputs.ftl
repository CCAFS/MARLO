...
[#assign currentStage = "plannedOutcomesOutputs" /]

[#assign breadCrumb = [
  {"label":"${currentSection}", "nameSpace":"", "action":""},
  {"label":"powbReport", "nameSpace":"powb", "action":"${crpSession}/summaryHighlight"},
  {"label":"plannedOutcomesOutputs", "nameSpace":"powb", "action":"${crpSession}/plannedOutcomesOutputs"}
]/]
...
[#-- Helptext --]
[@utilities.helpBox name="plannedOutcomesOutputs.help" param="${currentCycleYear}"/]
  ...
  <div class="row">
    ...
    <div class="col-md-9">
      ...
      [@s.form action=actionName method="POST" enctype="multipart/form-data" cssClass=""]
        ...
        [#-- Title --]
        <h3 class="headTitle">[@s.text name="plannedOutcomesOutputs.title" /]</h3>
        <div class="borderBox">
          <h5 class="sectionSubTitle">[@s.text name="plannedOutcomesOutputs.flagshipOutcomes"][@s.param]${liaisonInstitution.acronym}[/@s.param][/@s.text]</h5>
          [#list 1..3 as outcome]
            <div class="form-group outcomeBlock simpleBox">
              ...
              <div class="form-group">
                [@customForm.textArea name="liaisonInstitution.powb.plannedOutcomesOutputs" help="liaisonInstitution.powb.plannedOutcomesOutputs.help" required=true className="limitWords-100" editable=editable /]
              </div>
              
              <div class="form-group">
                [@customForm.textArea name="liaisonInstitution.powb.plannedKeyPatners" help="liaisonInstitution.powb.plannedKeyPatners.help" required=true className="limitWords-100" editable=editable /]
              </div>
              
              [#-- SRF Sub-IDO --]
              <div class="form-group">
                <h5 class="sectionSubTitle">[@s.text name="plannedOutcomesOutputs.srfSubIdo" /]</h5>
                <table class="">
                  <thead>
                    <tr>
                      <th>SRF Sub-IDO</th>
                  ...
                  <tbody>
                    [#list 1..2 as subIDO]
                    <tr>
                      <td>${subIDO}. Increased capacity for innovation in partner development organizations and in poor and vulnerable communities</td>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <h5 class="sectionSubTitle">[@s.text name="plannedOutcomesOutputs.outcomeContributions" /]</h5>
          <table class="">
            <thead>
              <tr>
                <th>Project ID</th>
        ...
        <div class="form-group">
          <h5 class="sectionSubTitle">[@s.text name="plannedOutcomesOutputs.milestoneContributions" /]</h5>
          <table class="">
            <thead>
              <tr>
                <th>Project ID</th>
