      ...
      [@s.form action=actionName method="POST" enctype="multipart/form-data" cssClass=""]
        ...
        <div class="borderBox">
          ...
          <div class="form-group margin-panel">
            [@customForm.textArea name="powbSynthesis.powbManagementRisk.highlight"  help="powbSynthesis.powbManagementRisk.highlight.help" paramText="${(actualPhase.year)!}" required=true className="limitWords-100" editable=editable /]
          </div>
