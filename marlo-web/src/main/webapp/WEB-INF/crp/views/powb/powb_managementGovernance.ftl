      ...
      [@s.form action=actionName method="POST" enctype="multipart/form-data" cssClass=""]
        ...
        <div class="borderBox">
          ...
          <div class="form-group margin-panel">
            [@customForm.textArea name="powbSynthesis.powbManagementGovernance.description"  help="powbSynthesis.powbManagementGovernance.description.help" paramText="${(actualPhase.year)!}" fieldEmptyText="global.prefilledByPmu" required=true className="" editable=editable && PMU /]
          </div>
