      ...
      [@s.form action=actionName method="POST" enctype="multipart/form-data" cssClass=""]
        ...
        <div class="borderBox">
          ...
          <div class="form-group">
            [@customForm.textArea name="powbSynthesis.crossCutting.summarize"  help="liaisonInstitution.powb.summarizeCorssCutting.help" paramText="${(actualPhase.year)!}" required=true className="limitWords-100" editable=editable && PMU /]
          </div>
        
          [#-- Open Data and Intellectual Assets --] 
          <div class="form-group">
            [@customForm.textArea name="powbSynthesis.crossCutting.assets" help="liaisonInstitution.powb.openDataIntellectualAssests.help" paramText="${(actualPhase.year)!}" required=true className="limitWords-100" editable=editable && PMU /]
          </div>
