      ...
      [@s.form action=actionName method="POST" enctype="multipart/form-data" cssClass=""]
        ...
        <div class="borderBox">
          ...
          <div class="form-group">
            [@customForm.textArea  name="powbSynthesis.crpStaffing.staffingIssues" i18nkey="powbSynthesis.crpStaffing.staffingIssues" help="powbSynthesis.crpStaffing.staffingIssues.help" paramText="${actualPhase.year}" required=true className="limitWords-100" editable=editable /]
          </div>
        ...
        [#if powbCrpStaffingCategories??]
          [#list powbCrpStaffingCategories  as crpStaffingCategory]
            ...
            <tr>
              ...
              <td> [@customForm.input name="${customName}.female" value="${(element.female)!}" i18nkey="" showTitle=false className="currencyInput text-center type-female category-${crpStaffingCategory_index}" required=true /]  </td>
              <td> [@customForm.input name="${customName}.male" value="${(element.male)!}" i18nkey="" showTitle=false className="currencyInput text-center type-male category-${crpStaffingCategory_index}" required=true /] </td>
