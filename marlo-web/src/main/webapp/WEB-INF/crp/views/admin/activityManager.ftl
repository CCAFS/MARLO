      ...
      <div class="col-md-9">
        ...
        <div class="program-block"  listname="activities">
          ...
          <div class="flagships items-list">
            ...
            <p class="text-center programMessage" style="display:${(activities?has_content)?string('none','block')}">[@s.text name="activityManagement.activity.notActivity.span" /]</p>
          </div>
...
[#macro activityItem element name template=false]
  ...
  <li id="user-${template?string('template',element.id)}" class="user userItem" style="display:${template?string('none','block')}">
    [#-- Activity Name --]
    <span class="glyphicon glyphicon-user" aria-hidden="true"></span><span class="name"> ${(element.title)!'Unknown activity'}</span>
    [#-- Hidden inputs --]
