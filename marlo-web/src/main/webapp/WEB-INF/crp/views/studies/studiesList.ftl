...
<section class="container">
  <article class="row" id="mainInformation">
    <div class="col-md-12">
      ...
      <div style="display:none">[@studiesList elements=action.getPublications(true) canValidate=true canEdit=true namespace="/studies" defaultAction="${(crpSession)!}/study" /]</div>
