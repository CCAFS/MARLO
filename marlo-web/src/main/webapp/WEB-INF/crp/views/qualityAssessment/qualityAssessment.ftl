...
[#include "/WEB-INF/global/pages/main-menu.ftl" /]
    ...
    <section class="container containerQA">   
      <div class="row">
            ...
            <div id="" class="">
              <div>
                <iframe width="100%"  height="1500px" src="[#if false]http://qatest.ciat.cgiar.org[#else]https://qa.cgiar.org[/#if]/crp?crp_id=${qATokenAuth.crpId}&token=${qATokenAuth.token}" frameborder="0"></iframe>
              </div>
            </div>  
      </div>
    </section>
