        ...
        [@s.form action=actionName method="POST" enctype="multipart/form-data" cssClass=""]
          ...
          <div id="projectDescription" class="borderBox">
            ...
            <div class="form-group">
              [@customForm.textArea name="project.projectInfo.title" i18nkey="project.title" required=true className="project-title limitWords-30" editable=(action.isAdmin() || action.canAccessSuperAdmin()) /]
            </div>
