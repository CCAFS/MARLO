            ...
            <div class="studiesTab">
              ...
              [#if expectedStudy.projectExpectedStudyInfo.studyType.id == 1]
                <ul class="nav nav-tabs" role="tablist">
                  ...
                  <li role="presentation" class="[#if indexTab==4]active[/#if]"><a index="4" href="#study-communications" aria-controls="communications" role="tab" data-toggle="tab">[@s.text name="study.general.communications" /]</a></li>
                </ul>
              [/#if]
