...
[#else]
  [#assign menus= [
    ...
    { 'title': 'Outcomes', 'show': isCrpProject,
      'items': [
      { 'slug': 'contributionsCrpList',  'name': 'projects.menu.contributionsCrpList',  'action': 'contributionsCrpList',  'active': ((crpSession != "WLE")!false), 'show':!phaseOne  && ((!project.projectInfo.administrative)!false) , "showCheck": isGlobalUnitProject},
