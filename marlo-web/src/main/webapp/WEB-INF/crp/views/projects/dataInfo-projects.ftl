...
<div id="top-quote">
  [#if project?has_content]
    <div id="projectID-quote" class="quote-id" title="[#if project.projectInfo.title?has_content]${project.projectInfo.title}[/#if]">
  ...
  [#if deliverable?has_content]
    ...
    <div id="deliverableID-quote" class="quote-id" title="[#if deliverable.deliverableInfo.title?has_content]${deliverable.deliverableInfo.title}[/#if]">
