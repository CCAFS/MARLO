...
<div class="animated flipInX container  viewMore-block containerAlertMargin">
  <div class=" containerAlert alert-leftovers alertColorBackgroundInfo "  id="containerAlert">
    ...
    <div class="containerText col-md-12">
      <p class="alertText">
        [@s.text name="projectContributionsCrpList.help" /] 
      </p>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-9">
        ...
        [#if reportingActive && canEdit] <p class="note">[@s.text name="projectContributionsCrpList.reportingHelp"/]</p>[/#if]
				...
				[#assign useTabs = action.hasSpecificities('show_contribution_performance_indicator_deprecated_tab_active')]
				...
				[#if useTabs?? && useTabs]
				  ...
				  <div class="tab-content">
				    <div class="tab-pane active" id="mainOutcomesTab">
				      <br>
