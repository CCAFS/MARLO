...
[#assign customJS = [
  "${baseUrlMedia}/js/projects/deliverables/deliverableInfo.js?20220622A",
  "${baseUrlMedia}/js/projects/deliverables/deliverableDissemination.js?20220622A",
  "${baseUrlMedia}/js/projects/deliverables/deliverableQualityCheck.js?20220622A",
