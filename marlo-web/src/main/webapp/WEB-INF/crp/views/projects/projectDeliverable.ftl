...
[#assign customJS = [
  "${baseUrlMedia}/js/projects/deliverables/deliverableInfo.js?20220314A",
  "${baseUrlMedia}/js/projects/deliverables/deliverableDissemination.js?20220411A", 
...
[#assign customCSS = [
  "${baseUrl}/crp/css/projects/projectDeliverable.css",
