...
[#assign customCSS = [
  ...
  "${baseUrlMedia}/css/projects/projectDeliverable.css?20210908a"] /]
      ...
      [#-- Section Messages --]
        ...
        [@s.form action=actionName method="POST" enctype="multipart/form-data" cssClass=""]
          ...
          <div class="">
            ...
            [/#if]
            <hr /> 
            [@deliverableList.deliverablesList deliverables=(currentDeliverableList)![] canValidate=true canEdit=candit  isReportingActive=reportingActive namespace="/projects" defaultAction="${(crpSession)!}/deliverable" projectID=projectID/]
          </div>
