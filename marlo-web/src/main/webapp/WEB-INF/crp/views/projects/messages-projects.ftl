  ...
  [#if !(isListSection??)]
    ...
    <div id="concurrenceBlock" class="text-center" style="display:none">
      ...
      <div class="content">
        ...
        <p>[@s.text name="project.message.concurrence" /] [@s.text name="project.message.concurrenceNotEditing"][@s.param] <a href="[@s.url][@s.param name="projectID" value=projectID /][@s.param name="edit" value="false" /][/@s.url]">click here</a> [/@s.param][/@s.text]</p>
      </div> 
    </div>
  [/#if]
