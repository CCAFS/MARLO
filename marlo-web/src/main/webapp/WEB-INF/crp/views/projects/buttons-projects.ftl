...
<div class="buttons">
  <div class="buttons-content">
    ...
    [/#if]
    [#if editable && !(transaction??) && (editable || action.canModifiedProjectStatus() || action.canEditAnyProjectExecution(project.id)) ]
      [#-- Discard Button --]
    ...
    [#elseif canEdit || action.canModifiedProjectStatus() || action.canEditAnyProjectExecution(project.id)]   
      [#-- Edit Button --]
