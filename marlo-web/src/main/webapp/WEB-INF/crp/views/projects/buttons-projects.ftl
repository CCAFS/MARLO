...
<div class="buttons">
  <div class="buttons-content">
    ...
    [/#if]
    [#if (editable || action.canModifiedProjectStatus() || action.canEditAnyProjectExecution()) && !(transaction??)]
      [#-- Discard Button --]
    ...
    [#elseif canEdit || action.canModifiedProjectStatus() || action.canEditAnyProjectExecution()]   
      [#-- Edit Button --]
