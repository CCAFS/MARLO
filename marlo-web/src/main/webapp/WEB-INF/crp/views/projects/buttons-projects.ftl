...
<div class="buttons">
  [#if !action.isProjectNew(projectID) && (hideJustification?? && !hideJustification)]
    [#if editable]
  ...
  <div class="buttons-content">
    ...
    [/#if]
    [#if editable || (reportingActive && action.hasPermission("statusDescription")) || (editStatus && action.isProjectDescription())]
      [#-- Back Button 
