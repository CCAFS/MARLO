            ...
            <div class="form-group geographicScopeBlock">      
              ...
              <div class="form-group simpleBox">
                ...
                <div class="form-group nationalBlock" style="display:${(isMultiNational || isNational || isSubNational)?string('block','none')}">
                  ...
                  [@customForm.select name="projectLp6Contribution.countriesIds" label="" i18nkey="projects.LP6Contribution.countries" listName="countries" keyFieldName="isoAlpha2"  displayFieldName="name" value="projectLp6Contribution.countriesIds" multiple=true required=false className="countriesSelect" disabled=!editable/]
                </div>
              </div>
            </div>
