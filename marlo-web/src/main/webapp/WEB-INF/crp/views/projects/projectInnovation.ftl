...
[#assign customJS = [
  ...
  "${baseUrlMedia}/js/projects/projectInnovations.js?20250811-A",
  "${baseUrlCdn}/global/js/fieldsValidation.js?20250805-A",
...
[#assign customCSS = [
  "${baseUrlMedia}/css/projects/projectInnovations.css?20250806",
