...
[#assign customJS = [
  "${baseUrlMedia}/js/projects/projectInnovations.js?20250519",
  "${baseUrlCdn}/global/js/fieldsValidation.js?20250519",
...
[#assign customCSS = ["${baseUrlMedia}/css/projects/projectInnovations.css?20250519-1"] /]
