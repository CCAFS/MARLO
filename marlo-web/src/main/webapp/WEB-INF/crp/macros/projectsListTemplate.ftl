        ...
        [/#if]
          ...
          <td class="left">
            ...
            [#if hasClusterType]
              ...
              [#if (project.projectInfo.clusterType.id) == 2]<span class="label label-success">[@s.text name="project.flagshipProject" /]</span>[/#if]
              [#if (project.projectInfo.clusterType.id) == 3]<span class="label label-success">[@s.text name="project.pmuProject" /]</span>[/#if]
