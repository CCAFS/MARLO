    ...
    [#if publications?has_content]
      [#list projects as project]
        ...
        <td class="projectId">
          ...
          <td>
            [#if true]
            <a href="[@s.url namespace="/publications" action='${(crpSession)!}/reportingSummary'][@s.param name='projectID']${project.id?c}[/@s.param][@s.param name='cycle']${action.getCurrentCycle()}[/@s.param][@s.param name='year']${action.getCurrentCycleYear()}[/@s.param][/@s.url]" target="__BLANK">
