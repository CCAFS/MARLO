  ...
  [/#if]
    ...
    <div class="block-involveParticipants">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-2 col-sm-2 femaleNumbers">
              <div class="text-area-container">
        ...
        [#list list as cluster]
          ...
          <div class="form-group row" clusterIdParticipant="${(cluster.project.id)!0}">
            ...
            <div class="col-md-2 col-sm-2 participantsNumbers">
              <div class="text-area-container">
            ...
            <div class="col-md-2 col-sm-2 africanNumbers">
              <div class="text-area-container">
            ...
            <div class="col-md-2 col-sm-2 youthNumbers">
              <div class="text-area-container">
  ...
  <div class="simpleBox form-group">
    ...
    <div class="block-notFindable findableOptions" style="display:${(isDisseminated == "false")?string('block', 'none')}">
      ...
      <div class="form-group confidentialBlock-true text-area-container" style="display:${(isConfidential == "true")?string('block', 'none')}">
        [@customForm.input name="${name}.confidentialUrl" type="text" i18nkey="project.deliverable.dissemination.confidentialUrl" help="project.deliverable.dissemination.confidentialUrl.help" helpIcon=false placeholder="global.webSiteLink.placeholder" className="" required=validateIsProgressWithStatus!true editable=editable /]
      </div>
...
[#macro deliverableMetadataMacro flagshipslistName="programs" crpsListName="crps" allowFlagships=true validateIsProgressWithStatus=true]
  ...
  <div class="form-group row">
    <div class="col-md-6">
      [@metadataField title="publicationDate" encodedName="dc.date" type="input" require=validateIsProgressWithStatus/]
    </div>
    [#if !action.isAiccra()]
    <div class="col-md-6">
  ...
  <div class="form-group row ifIsReadOnly" style="display: none;">
    ...
    <div class="col-md-6 conditionalRequire">
       [#assign isOtherUrl = (deliverable.dissemination.hasDOI)!false /]
       [@metadataField title="doi" encodedName="marlo.doi" type="input" require=(!isOtherUrl && validateIsProgressWithStatus!true)/]
    </div>
  </div>
  ...
  <div class="publicationMetadataBlock" style="display:${displayDeliverableRule(deliverable, deliverablePublicationMetadata)!};">
    ...
    <div class="form-group row">
      <div class="col-md-4 metadataElement metadataElement-volume no-lock">
        [@customForm.input name="deliverable.publication.volume" i18nkey="project.deliverable.dissemination.volume" className="metadataValue" type="text" disabled=!editable  required=validateIsProgressWithStatus editable=editable /]
      </div> 
      <div class="col-md-4 metadataElement metadataElement-issue no-lock">
        [@customForm.input name="deliverable.publication.issue" i18nkey="project.deliverable.dissemination.issue" className="metadataValue" type="text" disabled=!editable  required=validateIsProgressWithStatus editable=editable /]
      </div>
      <div class="col-md-4 metadataElement metadataElement-pages no-lock">
        [@customForm.input name="deliverable.publication.pages" i18nkey="project.deliverable.dissemination.pages" className="metadataValue" type="text" disabled=!editable  required=validateIsProgressWithStatus editable=editable /]
      </div>
    </div>
    <div class="form-group metadataElement metadataElement-journal no-lock">
      [@customForm.input name="deliverable.publication.journal" i18nkey="project.deliverable.dissemination.journalName" className="metadataValue" type="text" disabled=!editable  required=validateIsProgressWithStatus editable=editable /]
    </div>
    
    [#-- Is ISI Journal--]
    <div class="form-group isIsiJournal">
      <label for="">[@s.text name="deliverable.isiPublication" /] [@customForm.req required=(editable && validateIsProgressWithStatus!true) /]
...
[#macro deliverablePartnerMacro element name index=-1 defaultType=2 isTemplate=false]
  ...
  <div id="deliverablePartnerItem-${isTemplate?string('template', (element.id)! )}" class="simpleBox deliverablePartnerItem" style="display:${isTemplate?string('none', 'block')}">
    [#-- Remove --]
    [#if editable!false && !isResponsable]<div class="removePartnerItem removeElement removeLink sm" title="[@s.text name="project.deliverable.removePartnerContribution" /]"></div> [/#if]
...
[#macro contactPersonMacro element allSubActions name index=-1 partnerIndex=-1 isTemplate=false institutionID=-1]
