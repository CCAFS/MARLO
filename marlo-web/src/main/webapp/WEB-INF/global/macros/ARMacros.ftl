  ...
  <div class="block-geographicScope geographicScopeBlock">
    ...
    <div class="form-group">
      ...
      <div class="form-group nationalBlock" style="display:${(isMultiNational || isNational || isSubNational)?string('block','none')}">
        ...
        [@customForm.select name="${name}.countriesIds"  label="" i18nkey="deliverable.countries" listName="countries" keyFieldName="isoAlpha2"  displayFieldName="name" value="${name}.countriesIds"  multiple=true required=true className="countriesSelect" disabled=!editable/]
      </div>
    </div>
