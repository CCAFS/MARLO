    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <ul>
          ...
          <li><b>Already exists as Managing: </b><i>"InstitutionRequested"</i> is available in MARLO as Managing Partner. Please contact your PMU or <i>"ManagementLiaison Role"</i> in order to add it to the list of project partners</li>
