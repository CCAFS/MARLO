...
[#macro studyAlliance element name index=-1 template=false fromProject=true]
  ...
  <div class="borderBox">
    <div class="form-group">
      ...
      <div class="form-group">
        [@customForm.radioToCheckboxMacro label="study.allianceAligment.linkToLevers.options.primaryLever" name="${customName}" leverName="primary" listName=allianceLever displayFieldName="name" hasPrimary=true checkedValue=1 /]
      </div>
    </div>
  </div>
[/#macro]
