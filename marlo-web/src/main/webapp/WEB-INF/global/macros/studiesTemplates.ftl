  ...
  <div id="${customId}" class="caseStudy" style="display:${template?string('none','block')}">
    <div class="borderBox">
      <div class="form-group row">
        ...
        <div class="col-md-4">
          [@customForm.select name="${customName}.projectExpectedStudyInfo.status" className="setSelect2" i18nkey="study.status" listName="statuses" header=false required=true editable=editable /]
        </div>
        <div class="col-md-4">
      ...
      <div class="form-group geographicScopeBlock">
        ...
        <div class="form-group simpleBox">
          ...
          <div class="form-group regionalBlock" style="display:${(isRegional)?string('block','none')}">
            [#-- Regional scope --]
              [@customForm.elementsListComponent name="${customName}.studyRegions" elementType="repIndRegion" elementList=element.studyRegions label="study.region"  listName="regions" keyFieldName="id" displayFieldName="name" required=false /]
