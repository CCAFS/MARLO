...
<!doctype html>
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="${baseUrl}/global/css/global.css?20181031" />
    ...
    window.cookieconsent.initialise({
      ...
      "content": {
          "message": "By default, MARLO uses cookies to ensure you get the best experience on our website, analyze traffic and contact us in the online chat.",
