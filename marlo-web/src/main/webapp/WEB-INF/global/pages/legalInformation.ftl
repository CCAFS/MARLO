      ...
      <div class="simpleBox">
        ...
        <ol start="2">
          <li><strong>Copyright </strong>
            ...
            <p>Considering the nature of the platform and its adoption in the CGIAR through the CGIAR Research Programs, we decide to implement this version for this project funded by the World Bank called “Accelerating Innovation and Catalyzing Capacity for Resilience in Africa (AICCRA).” </p>
          </li>
        </ol>
