...
<div id="top-quote">
  [#if project?has_content]
    <div id="projectID-quote" class="quote-id" title="[#if project.name?has_content]${project.name}[/#if]">
      <a href="[@s.url namespace="/monitoring" action='${centerSession}/projectDescription'][@s.param name='projectID']${project.id?c}[/@s.param][#include "/WEB-INF/global/pages/urlGlobalParams.ftl" /][/@s.url]">
