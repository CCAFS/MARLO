  ...
  <table class="deliverablesList" id="deliverables">
    ...
    [#if deliverables?has_content]
      [#list deliverables as deliverable]         
        [#local deliverableUrl][@s.url namespace=namespace action=defaultAction][@s.param name='deliverableID']${deliverable.id?c}[/@s.param][#include "/WEB-INF/global/pages/urlGlobalParams.ftl" /][/@s.url][/#local]
        <tr>
        [#-- ID --]
