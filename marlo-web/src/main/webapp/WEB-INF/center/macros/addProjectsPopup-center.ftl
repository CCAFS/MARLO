...
<link rel="stylesheet" href="${baseUrlMedia}/css/monitoring/projects/addProjectsPopup.css">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h5>Do you want automatic setup the new project with external information? select what information you want to synchronize:</h5>
       
        <div class="form-group row">
          <div class="col-md-6">
          <p>[@customForm.radioFlat id="radio-manually" name="syncTypeID" label="Set-Up Information Manually" value="-1" checked=true  /]</p>
          [#if syncTypes??]
            [#list syncTypes as syncType]
              <p>[@customForm.radioFlat id="radio-${syncType.id}" name="syncTypeID" label=(syncType.syncName) value=(syncType.id) checked=false /]</p>
            [/#list]
          [/#if]
          </div>
         <div class="col-md-6">
