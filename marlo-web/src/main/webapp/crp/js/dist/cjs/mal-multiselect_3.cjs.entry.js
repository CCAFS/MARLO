...
const MalMultiselect = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: '1d7dd56f8e82909f24ca9ba6203e4e8fafa88c28' }, index.h("div", { key: '69913eb2f84f1f26e938737d8363a1e8f9ff37dc', id: "multi-select-container" })));
    }
...
const MalSelect = class {
    ...
    render() {
        return (index.h(index.Host, { key: '82ebc07899134c30e62615b91b81e0d94d9c8284' }, index.h("div", { key: '01a2f98aa261c76e283458107afdddd8ea8d7301', id: "react-dropdown" })));
    }
    static get watchers() { return {
        "data": ["onPropsChange"],
        "value": ["onPropsChange"]
...
const MyComponent = class {
    ...
    render() {
        return (index.h("div", { key: '1a35a1c2199a9c8be63be3d2df70c2fbda7b66d8' }, index.h("div", { key: 'd72f44361add83840a9e6037c2df812612681eb4', id: "vue-counter" }), index.h("style", { key: '08f7dd9371ef93df84197ad6435b0c35cac7da03' }, `
          .counter-container {
            padding: 20px;
            text-align: center;
