...
function opiAddDisRow($card) {
  ...
  // Keep the unit cloned from the principal row: "Not applicable" blanks and locks every
  // cell (opiApplyNotApplicable), which would leave the new row impossible to fill in.
  $row.find('.opi-dis__unitSelect').prop('disabled', false);
