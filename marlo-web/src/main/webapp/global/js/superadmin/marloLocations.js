...
function attachEvents() {
  ...
  $('.add-locElementType').on('click', addLocElementType);

  $('.remove-locElementType').on('click', removeLocElementType);
}

function addLocElementType() {
  var $parent = $(this).parent().parent();
  var $itemsList = $parent.parent().find('.items-list');
  var $item = $("#locElementType-template").clone(true).removeAttr("id");
  var data = {
