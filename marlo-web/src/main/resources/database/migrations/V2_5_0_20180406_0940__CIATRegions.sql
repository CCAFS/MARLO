...
INSERT INTO `crp_programs` VALUES ('130', 'Sustainable Food Systems', 'SFS', '1', '#D5D5D5', null, '1', '3', '2018-03-21 15:02:15', '1057', '', null, '29');
INSERT INTO `crp_programs` VALUES ('131', 'Climate Change', 'CC', '1', '#D5D5D5', null, '1', '3', '2018-03-21 15:02:15', '1057', '', null, '29');
INSERT INTO `crp_programs` VALUES ('132', 'Ecosystem Services', 'ES', '1', '#D5D5D5', null, '1', '3', '2018-03-21 15:02:15', '1057', '', null, '29');
INSERT INTO `crp_programs` VALUES ('133', 'Cassava', 'C', '1', '#D5D5D5', null, '1', '3', '2018-03-21 15:02:15', '1057', '', null, '29');
INSERT INTO `crp_programs` VALUES ('134', 'Bean', 'B', '1', '#D5D5D5', null, '1', '3', '2018-03-21 15:02:15', '1057', '', null, '29');
INSERT INTO `crp_programs` VALUES ('135', 'Rice', 'R', '1', '#D5D5D5', null, '1', '3', '2018-03-21 15:02:15', '1057', '', null, '29');
INSERT INTO `crp_programs` VALUES ('136', 'Genetic Resources', 'GR', '1', '#D5D5D5', null, '1', '3', '2018-03-21 15:02:15', '1057', '', null, '29');
INSERT INTO `crp_programs` VALUES ('137', 'Tropical Forages', 'TF', '1', '#D5D5D5', null, '1', '3', '2018-03-21 15:02:15', '1057', '', null, '29');
INSERT INTO `crp_programs` VALUES ('138', 'Soils and Climate Change', 'SCC', '1', '#D5D5D5', null, '1', '3', '2018-03-21 15:02:15', '1057', '', null, '29');
INSERT INTO `crp_programs` VALUES ('139', 'Restoring Degraded Land', 'RDL', '1', '#D5D5D5', null, '1', '3', '2018-03-21 15:02:15', '1057', '', null, '29');
INSERT INTO `crp_programs` VALUES ('140', 'Sustaining Soil Fertility and Health', 'SH', '1', '#D5D5D5', null, '1', '3', '2018-03-21 15:02:15', '1057', '', null, '29');
INSERT INTO `crp_programs` VALUES ('141', 'South America and the Caribbean (Headquarters)', 'SA', '2', '#D5D5D5', null, '1', '3', '2018-04-06 09:33:46', '3', ' ', '0', '29');
INSERT INTO `crp_programs` VALUES ('142', 'Central America', 'CA', '2', '#D5D5D5', null, '1', '3', '2018-04-06 09:34:08', '3', ' ', '0', '29');
INSERT INTO `crp_programs` VALUES ('143', 'Southeast Asia', 'SAS', '2', '#D5D5D5', null, '1', '3', '2018-04-06 09:34:27', '3', ' ', '0', '29');
INSERT INTO `crp_programs` VALUES ('144', 'Sub-Sahara Africa', 'SSA', '2', '#D5D5D5', null, '1', '3', '2018-04-06 09:34:49', '3', ' ', '0', '29');

--------------------------------------------------------------------------------------------------------------------------------------------------------------

INSERT INTO crp_program_leaders (user_id, crp_program_id, is_active, manager, created_by, active_since, modified_by, modification_justification)
VALUES (1543, 141, 1, 0, 3, NOW(), 3, '');

INSERT INTO crp_program_leaders (user_id, crp_program_id, is_active, manager, created_by, active_since, modified_by, modification_justification)
VALUES (1453, 142, 1, 0, 3, NOW(), 3, '');

INSERT INTO crp_program_leaders (user_id, crp_program_id, is_active, manager, created_by, active_since, modified_by, modification_justification)
VALUES (90, 143, 1, 0, 3, NOW(), 3, '');

INSERT INTO crp_program_leaders (user_id, crp_program_id, is_active, manager, created_by, active_since, modified_by, modification_justification)
VALUES (1857, 144, 1, 0, 3, NOW(), 3, '');
