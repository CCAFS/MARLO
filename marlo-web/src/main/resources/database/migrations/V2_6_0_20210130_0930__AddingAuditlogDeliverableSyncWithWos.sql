...
update deliverable_metadata_external_sources set created_by = 1082 where created_by = 0;
...
update deliverable_affiliations_not_mapped set created_by = 1082 where created_by = 0;
...
update external_source_author set created_by = 1082 where created_by = 0;
