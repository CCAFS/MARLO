...
INSERT INTO `roles` (`description`, `acronym`, `global_unit_id`, `order`) VALUES ('External System', 'ES', 24, 16);

INSERT INTO `role_permissions` (`role_id`, `permission_id`) VALUES ((SELECT r.id FROM `roles` r WHERE r.acronym = 'ES' AND global_unit_id = 24), 
