...
CREATE TABLE `report_synthesis_flagship_progress_cross` (
  ...
  `justification` text,
  `report_synthesis_flagship_progress_milestone_id` bigint(20) DEFAULT NULL,
  `cgiar_cross_cutting_marker_id` bigint(20) DEFAULT NULL,
  `rep_ind_gender_youth_focus_level_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `report_synthesis_flagship_progress_milestone_id` (`report_synthesis_flagship_progress_milestone_id`),
  ...
  CONSTRAINT `report_synthesis_flagship_progress_cross_ibfk_1` FOREIGN KEY (`report_synthesis_flagship_progress_milestone_id`) REFERENCES `report_synthesis_flagship_progress_milestones` (`id`),
