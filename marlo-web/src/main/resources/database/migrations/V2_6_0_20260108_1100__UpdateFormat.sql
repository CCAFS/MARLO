...
<style>
  ...
  .grid-item strong { font-size: 12px; color: #1F1F1F; word-break: break-word; }
  ...
  .partner-card__contact strong { font-size: 12px; color: #1F1F1F; }
  ...
  .contribution-card__block p { white-space: pre-line; font-size: 11px; }
  ...
  .contribution-list strong { display: block; font-size: 11px; color: #0a4c70; margin-bottom: 4px; }
  ...
  <section class="section section--page-break">
    ...
    <div class="contribution-card">
      <div class="contribution-card__header">
        ...
        <div class="contribution-card__meta">
          {{#if year}}<span class="tag tag--muted">Year {{#safeEmpty}}{{year}}{{/safeEmpty}}</span>{{/if}}
          {{#if newExpectedYear}}<span class="tag tag--muted">New Expected Year {{#safeEmpty}}{{newExpectedYear}}{{/safeEmpty}}</span>{{/if}}
