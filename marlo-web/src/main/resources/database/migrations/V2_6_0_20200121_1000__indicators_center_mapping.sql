...
CREATE TABLE `project_innovation_centers` (
  ...
  CONSTRAINT `project_innovation_centers_ibfk_3` FOREIGN KEY (`institution_id`) REFERENCES `institutions` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `project_expected_study_centers` (
  ...
  CONSTRAINT `project_expected_study_centers_ibfk_3` FOREIGN KEY (`institution_id`) REFERENCES `institutions` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `project_policy_centers` (
  ...
  CONSTRAINT `project_policy_centers_ibfk_3` FOREIGN KEY (`institution_id`) REFERENCES `institutions` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
