...
<div class="page">
    ...
    <div class="contribution-card">
      ...
      <div class="contribution-card__block">
        ...
        <ul class="contribution-list">
          ...
          <li>
            {{#if title}}<strong>{{#safeEmpty}}{{title}}{{/safeEmpty}}</strong>{{/if}}
            {{#unless title}}{{#if name}}<strong>{{#safeEmpty}}{{name}}{{/safeEmpty}}</strong>{{/if}}{{/unless}}
            {{#if id}}<span class="contribution-note">FS{{#safeEmpty}}{{id}}{{/safeEmpty}}</span>{{/if}}
            {{#if financeCode}}<span class="contribution-note">({{#safeEmpty}}{{financeCode}}{{/safeEmpty}})</span>{{/if}}
            {{#if geographicScope}}<p class="contribution-note">Geographic Scope: {{#safeEmpty}}{{geographicScope}}{{/safeEmpty}}</p>{{/if}}
            {{#if description}}<p>{{#safeEmpty}}{{description}}{{/safeEmpty}}</p>{{/if}}
          </li>
          {{/each}}
        </ul>
      </div>
      ...
      <div class="contribution-card__block">
        <h4>Funding Sources</h4>
        <div style="white-space: pre-line;">{{#safeEmpty}}{{fundingSources}}{{/safeEmpty}}</div>
      </div>
      {{/if}}
      {{/if}}
      {{#if genderLevels}}
      ...
      {{/if}}
      {{#if hasShfrmPriorityActions}}
      <div class="contribution-card__block">
        <h4>SHFRM Priority Actions</h4>
        <ul class="contribution-list">
          {{#each shfrmPriorityActions}}
          <li>
            {{#if name}}<strong>{{#safeEmpty}}{{name}}{{/safeEmpty}}</strong>{{/if}}
            {{#if hasSubActions}}
            <div style="margin-top: 25px; margin-left: 16px;">
              <strong style="font-size: 10px; letter-spacing: 0.08em; color: #6a7a89; text-transform: uppercase;">Sub Actions:</strong>
              <ul class="contribution-list" style="margin-top: 6px;">
                {{#each subActions}}
                <li>
                  {{#if name}}<strong>{{#safeEmpty}}{{name}}{{/safeEmpty}}</strong>{{/if}}
                </li>
      ...
      <div class="contribution-card__block">
        <h4>Dissemination Channel</h4>
        <p>{{#safeEmpty}}{{disseminationChannel}}{{/safeEmpty}}</p>
      </div>
      {{/if}}
      {{#if disseminationUrl}}
      <div class="contribution-card__block">
      ...
      <div class="contribution-card__block">
        <h4>Handle</h4>
        <p>{{#safeEmpty}}{{handle}}{{/safeEmpty}}</p>
      </div>
      {{/if}}
      {{#if doi}}
      <div class="contribution-card__block">
        <h4>DOI</h4>
        <p>{{#safeEmpty}}{{doi}}{{/safeEmpty}}</p>
      </div>
      {{/if}}
      {{#if isOpenAccess}}
      <div class="contribution-card__block">
        <h4>Is Open Access</h4>
        <p>{{#safeEmpty}}{{isOpenAccess}}{{/safeEmpty}}</p>
      </div>
      {{/if}}
      {{#if adoptedLicense}}
      <div class="contribution-card__block">
        <h4>Adopted License</h4>
        <p>{{#safeEmpty}}{{adoptedLicense}}{{/safeEmpty}}</p>
      </div>
      {{/if}}
      ...
      {{/if}}
      {{#if hasParticipantsText}}
      <div class="contribution-card__block">
        <h4>Participants</h4>
        <p><strong>Has Participants:</strong> {{#safeEmpty}}{{hasParticipantsText}}{{/safeEmpty}}</p>
        {{#if participant}}
        {{#if participant.eventActivityName}}
        <p><strong>Event/Activity Name:</strong> {{#safeEmpty}}{{participant.eventActivityName}}{{/safeEmpty}}</p>
        {{/if}}
        {{#if participant.activityType}}
        <p><strong>Activity Type:</strong> {{#safeEmpty}}{{participant.activityType}}{{/safeEmpty}}</p>
        {{/if}}
        {{#if participant.academicDegree}}
        <p><strong>Academic Degree:</strong> {{#safeEmpty}}{{participant.academicDegree}}{{/safeEmpty}}</p>
        {{/if}}
        {{#if participant.totalParticipants}}
        <p><strong>Total Participants:</strong> {{#safeEmpty}}{{participant.totalParticipants}}{{/safeEmpty}}</p>
        {{/if}}
        {{#if participant.females}}
        <p><strong>Females:</strong> {{#safeEmpty}}{{participant.females}}{{/safeEmpty}}</p>
        {{/if}}
        {{#if participant.africans}}
        <p><strong>Africans:</strong> {{#safeEmpty}}{{participant.africans}}{{/safeEmpty}}</p>
        {{/if}}
        {{#if participant.youth}}
        <p><strong>Youth:</strong> {{#safeEmpty}}{{participant.youth}}{{/safeEmpty}}</p>
        {{/if}}
        {{#if participant.participantType}}
        <p><strong>Participant Type:</strong> {{#safeEmpty}}{{participant.participantType}}{{/safeEmpty}}</p>
        {{/if}}
        {{#if participant.focus}}
        <p><strong>Focus:</strong> {{#safeEmpty}}{{participant.focus}}{{/safeEmpty}}</p>
        {{/if}}
        {{#if participant.likelyOutcomes}}
        <p><strong>Likely Outcomes:</strong> {{#safeEmpty}}{{participant.likelyOutcomes}}{{/safeEmpty}}</p>
        {{/if}}
        {{/if}}
      </div>
      {{/if}}
      ...
      <div class="contribution-card__block">
        ...
        <p>{{#safeEmpty}}{{sharedProjects}}{{/safeEmpty}}</p>
      </div>
      {{/if}}
      {{#if hasQualityCheck}}
      <div class="contribution-card__block">
        <h4>Quality Check</h4>
        {{#if qualityCheck.qualityAssurance}}
        <p><strong>Quality Assurance:</strong> {{#safeEmpty}}{{qualityCheck.qualityAssurance}}{{/safeEmpty}}</p>
        {{#if qualityCheck.fileAssurance}}
        <p><strong>File Assurance:</strong> {{#safeEmpty}}{{qualityCheck.fileAssurance}}{{/safeEmpty}}</p>
        {{/if}}
        {{#if qualityCheck.linkAssurance}}
        <p><strong>Link Assurance:</strong> <a href="{{#safeEmpty}}{{qualityCheck.linkAssurance}}{{/safeEmpty}}" target="_blank">{{#safeEmpty}}{{qualityCheck.linkAssurance}}{{/safeEmpty}}</a></p>
        {{/if}}
        {{/if}}
        {{#if qualityCheck.dataDictionary}}
        <p><strong>Data Dictionary:</strong> {{#safeEmpty}}{{qualityCheck.dataDictionary}}{{/safeEmpty}}</p>
        {{#if qualityCheck.fileDictionary}}
        <p><strong>File Dictionary:</strong> {{#safeEmpty}}{{qualityCheck.fileDictionary}}{{/safeEmpty}}</p>
        {{/if}}
        {{#if qualityCheck.linkDictionary}}
        <p><strong>Link Dictionary:</strong> <a href="{{#safeEmpty}}{{qualityCheck.linkDictionary}}{{/safeEmpty}}" target="_blank">{{#safeEmpty}}{{qualityCheck.linkDictionary}}{{/safeEmpty}}</a></p>
        {{/if}}
        {{/if}}
        {{#if qualityCheck.dataTools}}
        <p><strong>Data Tools:</strong> {{#safeEmpty}}{{qualityCheck.dataTools}}{{/safeEmpty}}</p>
        {{#if qualityCheck.fileTools}}
        <p><strong>File Tools:</strong> {{#safeEmpty}}{{qualityCheck.fileTools}}{{/safeEmpty}}</p>
        {{/if}}
        {{#if qualityCheck.linkTools}}
        <p><strong>Link Tools:</strong> <a href="{{#safeEmpty}}{{qualityCheck.linkTools}}{{/safeEmpty}}" target="_blank">{{#safeEmpty}}{{qualityCheck.linkTools}}{{/safeEmpty}}</a></p>
        {{/if}}
        {{/if}}
      </div>
      {{/if}}
  ...
  <section class="section section--page-break">
    ...
    <div class="contribution-card">
      ...
      {{#if descriptionStage}}
      <div class="contribution-card__block">
        <h4>Description Stage</h4>
        <p>{{#safeEmpty}}{{descriptionStage}}{{/safeEmpty}}</p>
      </div>
      {{/if}}
      ...
      {{/if}}
      {{#if contributingOrganizations}}
      <div class="contribution-card__block">
        <h4>Contributing Organizations</h4>
        <p>{{#safeEmpty}}{{contributingOrganizations}}{{/safeEmpty}}</p>
      </div>
      {{/if}}
      {{#if subIdos}}
      <div class="contribution-card__block">
