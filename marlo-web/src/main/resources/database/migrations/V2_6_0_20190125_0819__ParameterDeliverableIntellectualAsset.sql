...
VALUES (1, 'crp_deliverable_intellectual_asset', 'Display Deliverable Intellectual asset',1,2);
INSERT INTO parameters (global_unit_type_id, `key`, description, format, category)
VALUES (3, 'crp_deliverable_intellectual_asset', 'Display Deliverable Intellectual asset',1,2);
INSERT INTO parameters (global_unit_type_id, `key`, description, format, category)
VALUES (4, 'crp_deliverable_intellectual_asset', 'Display Deliverable Intellectual asset',1,2);
...
WHERE
p.`key` = 'crp_deliverable_intellectual_asset'
AND
