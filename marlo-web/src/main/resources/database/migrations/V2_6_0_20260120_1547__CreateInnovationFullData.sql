  ...
  <section class="section section--page-break">
    ...
    <div class="contribution-card">
      ...
      <div class="contribution-card__block">
        ...
        {{#if readinessReason}}<p><strong>Readiness Reason:</strong> {{#safeEmpty}}{{readinessReason}}{{/safeEmpty}}</p>{{/if}}
