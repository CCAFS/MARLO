...
INSERT INTO `permissions` VALUES ('52', 'crp:{0}:project:{1}:budgetByPartners:annualW1w2', 'Can update the W1/W2 budget in the project budget section in planning round', '1');
...
INSERT INTO `permissions` VALUES ('99', 'crp:{0}:project:{1}:deleteProject', 'Can use the \"Delete project\" button in any section in reporting round.', '1');
...
INSERT INTO `permissions` VALUES ('101', 'crp:{0}:project:{1}:contributionCrp:*', 'Can update everything in the CCAFS outcomes section in the reporting round.', '1');
...
INSERT INTO `permissions` VALUES ('106', 'crp:{0}:project:{1}:deliverableList:*', 'Can update the Deliverables List section in the reporting round.', '1');
...
INSERT INTO `permissions` VALUES ('130', 'crp:{0}:project:{1}:contributionCrp:canEdit', 'Can make changes in the ccafs outcomes section in reporting round.', '1');
INSERT INTO `permissions` VALUES ('131', 'crp:{0}:project:{1}:contributionCrp:target', 'Can update the target value in ccafs outcomes section in reporting round.', '1');
INSERT INTO `permissions` VALUES ('132', 'crp:{0}:project:{1}:contributionCrp:achieved', 'Can update the target achieved in ccafs outcomes section in reporting round.', '1');
INSERT INTO `permissions` VALUES ('133', 'crp:{0}:project:{1}:contributionCrp:description', 'Can update the expected annual contribution in ccafs outcomes section in reporting round.', '1');
INSERT INTO `permissions` VALUES ('134', 'crp:{0}:project:{1}:contributionCrp:narrativeTargets', 'Can update the annual contribution achieved in ccafs outcomes section in reporting round.', '1');
INSERT INTO `permissions` VALUES ('135', 'crp:{0}:project:{1}:contributionCrp:gender', 'Can update the expected gender contribution in ccafs outcomes section in reporting round.', '1');
INSERT INTO `permissions` VALUES ('136', 'crp:{0}:project:{1}:contributionCrp:narrativeGender', 'Can update the gender contribution achieved in ccafs outcomes section in reporting round.', '1');
...
INSERT INTO `permissions` VALUES ('168', 'crp:{0}:project:{1}:deliverableList:canEdit', 'Can make changes in the deliverables list section in reporting round.', '1');
INSERT INTO `permissions` VALUES ('169', 'crp:{0}:project:{1}:deliverableList:addDeliverable', 'Can add new deliverables in the deliverables list section in reporting round.', '1');
INSERT INTO `permissions` VALUES ('170', 'crp:{0}:project:{1}:deliverableList:removeOldDeliverables', 'Can remove deliverables in the deliverables list section in reporting round.', '1');
...
INSERT INTO `permissions` VALUES ('205', 'crp:{0}:project:{1}:budgetByPartners:*', 'Can update everything on project budgets in reporting round', '1');
INSERT INTO `permissions` VALUES ('206', 'crp:{0}:project:{1}:budgetByPartners:canEdit', 'Can update the planning project budget section in reporting round', '1');
INSERT INTO `permissions` VALUES ('207', 'crp:{0}:project:{1}:budgetByPartners:annualBilateral', 'Can update the W3/Bilateral budget in the project budget section in reporting round', '1');
INSERT INTO `permissions` VALUES ('208', 'crp:{0}:project:{1}:budgetByPartners:annualW1w2:canEdit', 'Can update the W1/W2 budget in the project budget section in reporting round', '1');
INSERT INTO `permissions` VALUES ('209', 'crp:{0}:project:{1}:budgetByCoAs:*', 'Can update everything in project budget by mog section in reporting round.', '1');
...
INSERT INTO `permissions` VALUES ('425', 'crp:{0}:impactPathway:canAcess', 'Can view all impactPathways', '3');
INSERT INTO `permissions` VALUES ('426', 'crp:{0}:impactPathway:*', 'All Access in Impact Pathway', '0');
INSERT INTO `permissions` VALUES ('427', 'crp:*', 'Full Crp Access', '0');
INSERT INTO `permissions` VALUES ('429', 'crp:{0}:project:{1}:projectSwitch', 'Acces to Switch Acces to the PL', '1');
INSERT INTO `permissions` VALUES ('430', 'crp:{0}:project:{1}:description:activities', 'Can update activites', '1');
INSERT INTO `permissions` VALUES ('431', 'crp:{0}:project:{1}:description:scale', 'Can update scale project', '1');
INSERT INTO `permissions` VALUES ('432', 'crp:{0}:project:{1}:description:scope', 'Can scope project', '1');
INSERT INTO `permissions` VALUES ('433', 'crp:{0}:project:{1}:contributionCrp:add', 'Can add a Project Outcome', '1');
INSERT INTO `permissions` VALUES ('434', 'crp:{0}:project:{1}:contributionCrp:delete', 'Can delete a Project Outcome', '1');
INSERT INTO `permissions` VALUES ('435', 'crp:{0}:project:{1}:contributionCrps:milestones', 'Can edit milestones', '1');
INSERT INTO `permissions` VALUES ('436', 'crp:{0}:project:{1}:contributionCrp:communications', 'Can edit Comunnications', '1');
INSERT INTO `permissions` VALUES ('437', 'crp:{0}:project:{1}:contributionsCrpList:*', 'Can view list', '1');
INSERT INTO `permissions` VALUES ('438', 'crp:{0}:fundingSource:{1}:canEdit', 'Cen edit Project Bilateral CoFunded', '1');
...
INSERT INTO `permissions` VALUES ('444', 'crp:{0}:fundingSource:w1', 'Can add and select w1 funding source', '0');
INSERT INTO `permissions` VALUES ('445', 'crp:{0}:fundingSource:w3', 'Can add and select w3 funding source', '0');
INSERT INTO `permissions` VALUES ('446', 'crp:{0}:project:{1}:fundingSource:w3', 'Pl and pc permission to w3', '1');
INSERT INTO `permissions` VALUES ('447', 'crp:{0}:project:{1}:fundingSource:{2}:w3', 'Cp add and select w3', '1');
...
INSERT INTO `role_permissions` VALUES ('2864', '52', '81');
...
INSERT INTO `role_permissions` VALUES ('2868', '14', '444');
INSERT INTO `role_permissions` VALUES ('2869', '14', '444');
INSERT INTO `role_permissions` VALUES ('2870', '20', '444');
INSERT INTO `role_permissions` VALUES ('2871', '27', '444');
...
INSERT INTO `role_permissions` VALUES ('2882', '52', '446');
INSERT INTO `role_permissions` VALUES ('2883', '57', '446');
INSERT INTO `role_permissions` VALUES ('2884', '58', '446');
INSERT INTO `role_permissions` VALUES ('2885', '59', '446');
INSERT INTO `role_permissions` VALUES ('2888', '9', '446');
INSERT INTO `role_permissions` VALUES ('2889', '53', '446');
INSERT INTO `role_permissions` VALUES ('2890', '54', '446');
INSERT INTO `role_permissions` VALUES ('2891', '55', '446');
