    ...
    <div class="partner-card">
      ...
      <div class="partner-card__section partner-card__contacts">
        ...
        <div class="partner-card__contact">
          <strong>{{#safeEmpty}}{{name}}{{/safeEmpty}}</strong>
          {{#role}}
          <span class="partner-card__role">{{#safeEmpty}}{{.}}{{/safeEmpty}}</span>
          {{/role}}
          {{^role}}
          <span class="partner-card__role partner-card__role--muted">&lt;Not provided&gt;</span>
          {{/role}}
...
<div id="pageFooter">
  ...
  <span>MARLO AICCRA Cluster Report</span>
</div>
</body>
</html>'
WHERE id = 1;
