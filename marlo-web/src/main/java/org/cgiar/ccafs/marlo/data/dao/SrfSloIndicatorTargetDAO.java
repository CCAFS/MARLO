...
import org.cgiar.ccafs.marlo.data.dao.mysql.SrfSloIndicatorTargetMySQLDAO;
...
@ImplementedBy(SrfSloIndicatorTargetMySQLDAO.class)
public interface SrfSloIndicatorTargetDAO {
   ...
   * @return a number greater than 0 representing the new ID assigned by the database, 0 if the srfSloIndicatorTarget was
   *         updated
