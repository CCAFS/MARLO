...
import org.cgiar.ccafs.marlo.data.manager.impl.ProjectClusterActivityManagerImpl;
 ...
 */
@ImplementedBy(ProjectClusterActivityManagerImpl.class)
public interface ProjectClusterActivityManager {
