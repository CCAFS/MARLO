...
import org.cgiar.ccafs.marlo.data.manager.impl.CrpProgramCountryManagerImpl;
 ...
 */
@ImplementedBy(CrpProgramCountryManagerImpl.class)
public interface CrpProgramCountryManager {
