 ...
 */
public class ProgramChangesAction extends BaseAction {
  ...
  private ProgramChangeValidator validator;


  private PowbProgramChangeManager powbProgramChangeManager;
  ...
  @Inject
  public ProgramChangesAction(APConfig config, GlobalUnitManager crpManager,
    LiaisonInstitutionManager liaisonInstitutionManager, AuditLogManager auditLogManager, UserManager userManager,
    CrpProgramManager crpProgramManager, PowbSynthesisManager powbSynthesisManager, ProgramChangeValidator validator,
    PowbProgramChangeManager powbProgramChangeManager) {
    super(config);
    ...
    this.powbProgramChangeManager = powbProgramChangeManager;
  }
  ...
  public String save() {
    if (this.hasPermission("canEdit")) {
      ...
      PowbProgramChange powbProgramChangeDB =
        powbSynthesisManager.getPowbSynthesisById(powbSynthesisID).getPowbProgramChange();


      powbProgramChangeDB.setProgramChange(powbSynthesis.getPowbProgramChange().getProgramChange());
      powbProgramChangeDB = powbProgramChangeManager.savePowbProgramChange(powbProgramChangeDB);
  ...
  public void tocList(long phaseID) {
    ...
    for (LiaisonInstitution liaisonInstitution : liaisonInstitutions) {
      ...
      if (powbSynthesis != null) {
        if (powbSynthesis.getPowbProgramChange() != null) {
          if (powbSynthesis.getPowbProgramChange().getProgramChange() != null) {
            powbTocList.setOverall(powbSynthesis.getPowbProgramChange().getProgramChange());
          }
        }
      }
