 ...
 * @author AVALENCIA
 */
public class BaseLp6Action extends BaseAction {


  private static final long serialVersionUID = 2837063045483756677L;


  private static Logger LOG = LoggerFactory.getLogger(BaseLp6Action.class);
  ...
  public BaseLp6Action(APConfig config, GlobalUnitManager crpManager, PhaseManager phaseManager,
