 ...
 */
public class DeliverablePublicationMetadata extends MarloBaseEntity implements java.io.Serializable, IAuditLog {
  ...
  public String toString() {
    return "DeliverablePublicationMetadata [id=" + this.getId() + ", deliverable=" + deliverable + ", volume=" + volume
