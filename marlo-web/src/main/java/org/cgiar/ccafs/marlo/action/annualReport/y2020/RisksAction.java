...
import org.cgiar.ccafs.marlo.validation.annualreport.y2018.Risk2018Validator;
...
public class RisksAction extends BaseAction {
  ...
  private ReportSynthesisRiskManager reportSynthesisRiskManager;
  private Risk2018Validator validator;
  ...
  @Inject
  public RisksAction(APConfig config, GlobalUnitManager crpManager, LiaisonInstitutionManager liaisonInstitutionManager,
    ReportSynthesisManager reportSynthesisManager, AuditLogManager auditLogManager, UserManager userManager,
    CrpProgramManager crpProgramManager, ReportSynthesisRiskManager reportSynthesisRiskManager,
    Risk2018Validator validator) {
    super(config);
    ...
    this.reportSynthesisRiskManager = reportSynthesisRiskManager;
