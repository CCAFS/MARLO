 ...
 */
@Named
public class InfluenceValidator extends BaseValidator {

  private final GlobalUnitManager crpManager;
  private final ReportSynthesisManager reportSynthesisManager;

  public InfluenceValidator(GlobalUnitManager crpManager, ReportSynthesisManager reportSynthesisManager) {
  ...
  private Path getAutoSaveFilePath(ReportSynthesis reportSynthesis, long crpID, BaseAction baseAction) {
    ...
    String actionFile = ReportSynthesisSectionStatusEnum.INFLUENCE.getStatus().replace("/", "_");
    String autoSaveFile =
