...
import org.cgiar.ccafs.marlo.data.manager.impl.ProjectCommunicationManagerImpl;
 ...
 */
@ImplementedBy(ProjectCommunicationManagerImpl.class)
public interface ProjectCommunicationManager {
