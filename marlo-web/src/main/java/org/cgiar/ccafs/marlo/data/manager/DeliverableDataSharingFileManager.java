...
public interface DeliverableDataSharingFileManager {
   ...
   * 
   * @param deliverableDataSharingFile - is the deliverableDataSharingFile object with the new information to be
   *        added/updated.
   * @return a number greater than 0 representing the new ID assigned by the database, 0 if the
   *         deliverableDataSharingFile was
   *         updated
   *         or -1 is some error occurred.
   */
  public DeliverableDataSharingFile
    saveDeliverableDataSharingFile(DeliverableDataSharingFile deliverableDataSharingFile);
