...
import org.cgiar.ccafs.marlo.validation.annualreport.y2018.Efficiency2018Validator;
...
public class EfficiencyAction extends BaseAction {
  ...
  private Efficiency2018Validator validator;
  ...
  @Inject
  public EfficiencyAction(APConfig config, GlobalUnitManager crpManager,
    LiaisonInstitutionManager liaisonInstitutionManager, ReportSynthesisManager reportSynthesisManager,
    AuditLogManager auditLogManager, UserManager userManager, CrpProgramManager crpProgramManager,
    Efficiency2018Validator validator, ReportSynthesisEfficiencyManager reportSynthesisEfficiencyManager) {
    super(config);
  ...
  public void prepare() throws Exception {
    ...
    if (reportSynthesis != null) {
      ...
      if (path.toFile().exists() && this.getCurrentUser().isAutoSave()) {
        ...
        this.setDraft(false);
        // Check if Efficiency relation is null -create it
    ...
    if (this.isFlagship()) {
      ...
      if (reportSynthesisDB != null) {
        if (reportSynthesisDB.getReportSynthesisEfficiency() != null) {
          pmuText = reportSynthesisDB.getReportSynthesisEfficiency().getDescription();
        }
      }
    }
    ...
    this.setBasePermission(this.getText(Permission.REPORT_SYNTHESIS_EFFICIENCY_BASE_PERMISSION, params));
  }
  ...
  public String save() {
    if (this.hasPermission("canEdit")) {
      ...
      ReportSynthesisEfficiency reportEfficiencyDB =
        reportSynthesisManager.getReportSynthesisById(synthesisID).getReportSynthesisEfficiency();

      reportEfficiencyDB.setDescription(reportSynthesis.getReportSynthesisEfficiency().getDescription());
      reportEfficiencyDB = reportSynthesisEfficiencyManager.saveReportSynthesisEfficiency(reportEfficiencyDB);
