...
public class StatusPlannedOutcomesItem<T> {
                    ...
                    if (reportSynthesisFlagshipProgressOutcome == null) {
                        ...
                        if (fieldErrors.isEmpty()) {
                            ...
                            try {
                                ...
                                String originalJson = mapper.writerWithDefaultPrettyPrinter().writeValueAsString(newStatusPlannedOutcomeDTO);
                                RestApiAuditlog restApiAuditLog = new RestApiAuditlog("createStatusPlannedOutcome", "Created CGIAR Entity Acronym " + CGIARentityAcronym + " ID " + plannedOutcomeStatusID, new Date(), plannedOutcomeStatusID, "class org.cgiar.ccafs.marlo.data.model.ReportSynthesisFlagshipProgressOutcome",
    ...
    public ResponseEntity<StatusPlannedOutcomesDTO> findStatusPlannedOutcome(String outcomeID, String CGIARentityAcronym,
        ...
        // Log Action
        RestApiAuditlog restApiAuditLog = new RestApiAuditlog("findStatusPlannedOutcomeById", "Searched CGIAR Entity Acronym " + CGIARentityAcronym + " ID " + outcomeID + " Year:" + repoYear + " Phase: " + repoPhase, new Date(), Long.parseLong(outcomeID), "class org.cgiar.ccafs.marlo.data.model.ReportSynthesisFlagshipProgressOutcome",
                    ...
                    if (reportSynthesisFlagshipProgressOutcomeList != null
                        ...
                        if (reportSynthesisFlagshipProgressOutcome != null) {
                            ...
                            try {
                                ObjectMapper mapper = new ObjectMapper();
                                String originalJson = mapper.writerWithDefaultPrettyPrinter().writeValueAsString(newStatusPlannedOutcomeDTO);
                                RestApiAuditlog restApiAuditLog = new RestApiAuditlog("updateStatusPlannedOutcome", "Updated " + plannedOutcomeStatusID, new Date(), plannedOutcomeStatusID, "class org.cgiar.ccafs.marlo.data.model.ReportSynthesisFlagshipProgressOutcome",
                                        originalJson, user.getId(), null, "", phase.getId());
                                restApiAuditlogManager.logApiCall(restApiAuditLog);
                            } catch (JsonProcessingException ex) {
                                Logger.getLogger(StatusPlannedOutcomesItem.class.getName()).log(Level.SEVERE, null, ex);
