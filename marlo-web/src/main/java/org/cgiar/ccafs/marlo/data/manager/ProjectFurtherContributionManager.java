...
public interface ProjectFurtherContributionManager {
   ...
   * 
   * @param projectFurtherContribution - is the projectFurtherContribution object with the new information to be
   *        added/updated.
   * @return a number greater than 0 representing the new ID assigned by the database, 0 if the
   *         projectFurtherContribution was
   *         updated
   *         or -1 is some error occurred.
   */
  public ProjectFurtherContribution
    saveProjectFurtherContribution(ProjectFurtherContribution projectFurtherContribution);
