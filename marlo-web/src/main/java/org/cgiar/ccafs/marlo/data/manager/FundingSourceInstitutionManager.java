...
import org.cgiar.ccafs.marlo.data.manager.impl.FundingSourceInstitutionManagerImpl;
 ...
 */
@ImplementedBy(FundingSourceInstitutionManagerImpl.class)
public interface FundingSourceInstitutionManager {
   ...
   * 
   * @param fundingSourceInstitution - is the fundingSourceInstitution object with the new information to be added/updated.
   * @return a number greater than 0 representing the new ID assigned by the database, 0 if the fundingSourceInstitution was
   *         updated
