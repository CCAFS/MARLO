...
import org.cgiar.ccafs.marlo.data.dao.mysql.ProjectPartnerContributionMySQLDAO;
...
@ImplementedBy(ProjectPartnerContributionMySQLDAO.class)
public interface ProjectPartnerContributionDAO {
   ...
   * 
   * @param projectPartnerContribution - is the projectPartnerContribution object with the new information to be added/updated.
   * @return a number greater than 0 representing the new ID assigned by the database, 0 if the projectPartnerContribution was
   *         updated
