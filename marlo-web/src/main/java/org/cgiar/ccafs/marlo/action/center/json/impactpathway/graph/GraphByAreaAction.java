...
public class GraphByAreaAction extends BaseAction {
  ...
  @Inject
  public GraphByAreaAction(APConfig config, ICenterProgramManager programService,
      ...
      for (CenterTopic topic : topics) {
        ...
        for (CenterOutcome outcome : outcomes) {
          ...
          dataOutcomeDetail.put("label",
            this.isShortName(outcome.getShortName()) ? outcome.getShortName() : "Outcome - OC" + outcome.getId());
          dataOutcomeDetail.put("title", this.isShortName(outcome.getShortName())
            ? "Outcome - " + outcome.getShortName() : "Outcome - OC" + outcome.getId());
