...
public class ObjectFactory {
    ...
    private final static QName _GetMarloPlaResponse_QNAME = new QName("http://logic.control.abw.ciat.cgiar.org/", "getMarloPlaResponse");
    private final static QName _GetMarloPlaCountry_QNAME = new QName("http://logic.control.abw.ciat.cgiar.org/", "getMarloPlaCountry");
    private final static QName _GetMarloAgreementsResponse_QNAME = new QName("http://logic.control.abw.ciat.cgiar.org/", "getMarloAgreementsResponse");
    private final static QName _GetMarloAgreeCountry_QNAME = new QName("http://logic.control.abw.ciat.cgiar.org/", "getMarloAgreeCountry");
    private final static QName _GetMarloAgreements_QNAME = new QName("http://logic.control.abw.ciat.cgiar.org/", "getMarloAgreements");
    private final static QName _GetMarloPlaCountryResponse_QNAME = new QName("http://logic.control.abw.ciat.cgiar.org/", "getMarloPlaCountryResponse");
    private final static QName _GetMarloAgreeCountryResponse_QNAME = new QName("http://logic.control.abw.ciat.cgiar.org/", "getMarloAgreeCountryResponse");
    private final static QName _GetMarloAgreeCrp_QNAME = new QName("http://logic.control.abw.ciat.cgiar.org/", "getMarloAgreeCrp");
    ...
    public JAXBElement<GetMarloAgreementsResponse> createGetMarloAgreementsResponse(GetMarloAgreementsResponse value) {
        return new JAXBElement<GetMarloAgreementsResponse>(_GetMarloAgreementsResponse_QNAME, GetMarloAgreementsResponse.class, null, value);
    }
    ...
    public JAXBElement<GetMarloPlaCountryResponse> createGetMarloPlaCountryResponse(GetMarloPlaCountryResponse value) {
        return new JAXBElement<GetMarloPlaCountryResponse>(_GetMarloPlaCountryResponse_QNAME, GetMarloPlaCountryResponse.class, null, value);
    }
    ...
    public JAXBElement<GetMarloAgreeCountryResponse> createGetMarloAgreeCountryResponse(GetMarloAgreeCountryResponse value) {
        return new JAXBElement<GetMarloAgreeCountryResponse>(_GetMarloAgreeCountryResponse_QNAME, GetMarloAgreeCountryResponse.class, null, value);
    }
    ...
    public JAXBElement<GetMarloAgreeCrpResponse> createGetMarloAgreeCrpResponse(GetMarloAgreeCrpResponse value) {
        return new JAXBElement<GetMarloAgreeCrpResponse>(_GetMarloAgreeCrpResponse_QNAME, GetMarloAgreeCrpResponse.class, null, value);
    }
