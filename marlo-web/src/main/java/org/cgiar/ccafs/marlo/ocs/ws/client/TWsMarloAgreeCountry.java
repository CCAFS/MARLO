...
public class TWsMarloAgreeCountry implements java.io.Serializable {
  ...
  static {
    typeDesc
      .setXmlType(new javax.xml.namespace.QName("http://logic.control.abw.ciat.cgiar.org/", "tWsMarloAgreeCountry"));
  ...
  private org.cgiar.ccafs.marlo.ocs.ws.client.TWsMarloAgreeCountryId id;
  ...
  public TWsMarloAgreeCountry(org.cgiar.ccafs.marlo.ocs.ws.client.TWsMarloAgreeCountryId id) {
    this.id = id;
  }

  @Override
  public synchronized boolean equals(java.lang.Object obj) {
    if (!(obj instanceof TWsMarloAgreeCountry)) {
      return false;
    }
   ...
   * @return id
   */
  public org.cgiar.ccafs.marlo.ocs.ws.client.TWsMarloAgreeCountryId getId() {
    return id;
  }
   ...
   * @param id
   */
  public void setId(org.cgiar.ccafs.marlo.ocs.ws.client.TWsMarloAgreeCountryId id) {
    this.id = id;
  }
