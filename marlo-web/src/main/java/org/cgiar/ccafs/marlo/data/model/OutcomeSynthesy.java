 ...
 */
public class OutcomeSynthesy extends MarloBaseEntity implements java.io.Serializable, IAuditLog {
  ...
  public String toString() {
    return "OutcomeSynthesy [id=" + this.getId() + ", ipElement=" + ipElement + ", ipIndicator=" + ipIndicator
      + ", ipProgram=" + ipProgram + ", year=" + year + ", achieved=" + achieved + ", synthesisAnual=" + synthesisAnual
