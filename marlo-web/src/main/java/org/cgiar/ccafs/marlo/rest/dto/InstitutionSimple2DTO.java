...
public class InstitutionSimple2DTO {
  ...
  public void setCountryOfficeDTO(List<CountryOfficeDTO> countryOfficeDTO) {
    this.countryOfficeDTO = countryOfficeDTO;
  }
