 ...
 */
@Named
public class ManagementRiskValidator extends BaseValidator {

  private final GlobalUnitManager crpManager;

  public ManagementRiskValidator(GlobalUnitManager crpManager) {
    super();
  ...
  public void validate(BaseAction action, PowbSynthesis powbSynthesis, boolean saving) {
    ...
    if (powbSynthesis != null) {
      ...
      this.validateManagementRisk(action, powbSynthesis);
