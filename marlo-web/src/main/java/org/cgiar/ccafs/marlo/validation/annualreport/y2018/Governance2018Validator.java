 ...
 */
@Named
public class Governance2018Validator extends BaseValidator {

  private final GlobalUnitManager crpManager;
  private final ReportSynthesisManager reportSynthesisManager;

  public Governance2018Validator(GlobalUnitManager crpManager, ReportSynthesisManager reportSynthesisManager) {
  ...
  private Path getAutoSaveFilePath(ReportSynthesis reportSynthesis, long crpID, BaseAction baseAction) {
    ...
    String actionFile = ReportSynthesis2018SectionStatusEnum.GOVERNANCE.getStatus().replace("/", "_");
    String autoSaveFile =
    ...
    if (reportSynthesis != null) {
      ...
      if (this.isPMU(this.getLiaisonInstitution(action, reportSynthesis.getId()))) {
        ...
        if (!this.isValidString(reportSynthesis.getReportSynthesisGovernance().getDescription())) {
          action.addMessage(action.getText("annualReport2018.governance.describe.readText"));
      ...
      this.saveMissingFields(reportSynthesis, action.getActualPhase().getDescription(),
        ...
        ReportSynthesis2018SectionStatusEnum.GOVERNANCE.getStatus(), action);
    }
