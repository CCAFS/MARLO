...
import org.cgiar.ccafs.marlo.data.manager.impl.CenterImpactObjectiveManager;
 ...
 */
@ImplementedBy(CenterImpactObjectiveManager.class)
public interface ICenterImpactObjectiveManager {
   ...
   * 
   * @return a list from CenterImpactObjective null if no exist records
   */
   ...
   * 
   * @param researchImpactObjectiveID is the researchImpactObjective identifier.
   * @return a CenterImpactObjective object.
   */
   ...
   * 
   * @param researchImpactObjective - is the researchImpactObjective object with the new information to be
   *        added/updated.
   * @return a number greater than 0 representing the new ID assigned by the database, 0 if the researchImpactObjective
   *         was
   *         updated
