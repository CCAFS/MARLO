...
import org.cgiar.ccafs.marlo.validation.annualreport.EfficiencyValidator;
...
public class EfficiencyAction extends BaseAction {
  ...
  private EfficiencyValidator validator;
  ...
  public EfficiencyAction(APConfig config, GlobalUnitManager crpManager,
    ...
    EfficiencyValidator validator, ReportSynthesisEfficiencyManager reportSynthesisEfficiencyManager) {
    super(config);
