 ...
 */
@Named
public class ProgramVarianceValidator extends BaseValidator {

  private final GlobalUnitManager crpManager;
  private final ReportSynthesisManager reportSynthesisManager;

  public ProgramVarianceValidator(GlobalUnitManager crpManager, ReportSynthesisManager reportSynthesisManager) {
  ...
  private Path getAutoSaveFilePath(ReportSynthesis reportSynthesis, long crpID, BaseAction baseAction) {
    ...
    String actionFile = ReportSynthesisSectionStatusEnum.VARIANCE.getStatus().replace("/", "_");
    String autoSaveFile =
  ...
  public void validate(BaseAction action, ReportSynthesis reportSynthesis, boolean saving) {
    ...
    if (reportSynthesis != null) {
      ...
      if (!this.isValidString(reportSynthesis.getReportSynthesisProgramVariance().getDescription())) {
        action.addMessage(action.getText("annualReport.plannedVariance.summary"));
        action.getInvalidFields().put("input-reportSynthesis.reportSynthesisProgramVariance.description",
      ...
      this.saveMissingFields(reportSynthesis, action.getActualPhase().getDescription(),
        action.getActualPhase().getYear(), ReportSynthesisSectionStatusEnum.VARIANCE.getStatus(), action);
    }
