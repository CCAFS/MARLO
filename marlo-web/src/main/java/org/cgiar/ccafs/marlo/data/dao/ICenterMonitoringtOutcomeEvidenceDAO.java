...
import org.cgiar.ccafs.marlo.data.dao.mysql.CenterMonitoringOutcomeEvidenceDAO;
...
@ImplementedBy(CenterMonitoringOutcomeEvidenceDAO.class)
public interface ICenterMonitoringtOutcomeEvidenceDAO {
   ...
   * 
   * @param monitorignOutcomeEvidence - is the monitorignOutcomeEvidence object with the new information to be
   *        added/updated.
   * @return a number greater than 0 representing the new ID assigned by the database, 0 if the
   *         monitorignOutcomeEvidence was
   *         updated
