...
public interface KeyPartnershipCollaborationCrpMapper {

  @Mappings({@Mapping(source = "globalUnit.acronym", target = "acronym"),
    @Mapping(source = "globalUnit.globalUnitType", target = "cgiarEntityTypeDTO"),
    @Mapping(source = "globalUnit.smoCode", target = "code"), @Mapping(source = "globalUnit.name", target = "name"),})
  public abstract CGIAREntityDTO keyPartnershipCollaborationCrpToCgiarEntityDTO(
