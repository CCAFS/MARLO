...
public interface CrpProgramManager {
  ...
  /**
   * This method validate if the crpProgram identify with the given id exists
   * in the system.
   * 
  ...
  /**
   * This method gets a crpProgram object by a given crpProgram smo code.
   * 
   * @param smo code is the crpProgram identifier defined by SMO.
   * @return a CrpProgram object.
   */
  ...
  /**
   * This method validate if the LiaisonInstitution is a flagship
   * 
   * @param liaisonInstitution
   * @return true if it is a flagship
   */
   ...
   * 
   * @param crpProgram - is the crpProgram object with the new information to
   *        be added/updated.
   * @return a number greater than 0 representing the new ID assigned by the
   *         database, 0 if the crpProgram was updated or -1 is some error occurred.
   */
