 ...
 */
@Named
public class Risk2018Validator extends BaseValidator {

  private final GlobalUnitManager crpManager;
  private final ReportSynthesisManager reportSynthesisManager;

  public Risk2018Validator(GlobalUnitManager crpManager, ReportSynthesisManager reportSynthesisManager) {
  ...
  private Path getAutoSaveFilePath(ReportSynthesis reportSynthesis, long crpID, BaseAction baseAction) {
    ...
    String actionFile = ReportSynthesis2018SectionStatusEnum.RISKS.getStatus().replace("/", "_");
    String autoSaveFile =
    ...
    if (reportSynthesis != null) {
      ...
      if (this.isPMU(this.getLiaisonInstitution(action, reportSynthesis.getId()))) {
        ...
        if (!this.isValidString(reportSynthesis.getReportSynthesisRisk().getBriefSummary())) {
          action.addMessage(action.getText("annualReport.risks.summary.readText"));
          action.getInvalidFields().put("input-reportSynthesis.reportSynthesisRisk.briefSummary",
      ...
      this.saveMissingFields(reportSynthesis, action.getActualPhase().getDescription(),
        ...
        ReportSynthesis2018SectionStatusEnum.RISKS.getStatus(), action);
    }
