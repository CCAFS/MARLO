...
import org.cgiar.ccafs.marlo.data.manager.impl.CenterFundingSyncTypeManagerImpl;
 ...
 */
@ImplementedBy(CenterFundingSyncTypeManagerImpl.class)
public interface CenterFundingSyncTypeManager {
