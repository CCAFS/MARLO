 ...
 */
public class test3Action extends BaseAction implements Summary {

  private static final long serialVersionUID = -624982650510682813L;
  private static Logger LOG = LoggerFactory.getLogger(test3Action.class);
  ...
  @Inject
  public test3Action(APConfig config, CrpManager crpManager, ProjectManager projectManager,
  ...
  public String execute() throws Exception {
    ...
    try {
      Resource reportResource = manager.createDirectly(
        this.getClass().getResource("/pentaho/Pruebautf8HtmlArialUnicodeEmbeed.prpt"), MasterReport.class);
