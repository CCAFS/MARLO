...
import org.cgiar.ccafs.marlo.data.manager.impl.CenterAllTypesManagerImpl;
 ...
 */
@ImplementedBy(CenterAllTypesManagerImpl.class)
public interface CenterAllTypesManager {
   ...
   */
  public CenterAllTypes saveCenterAllTypes(CenterAllTypes centerAllTypes);
