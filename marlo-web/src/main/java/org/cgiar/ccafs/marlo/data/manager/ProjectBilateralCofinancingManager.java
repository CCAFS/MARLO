...
import org.cgiar.ccafs.marlo.data.manager.impl.ProjectBilateralCofinancingManagerImpl;
 ...
 */
@ImplementedBy(ProjectBilateralCofinancingManagerImpl.class)
public interface ProjectBilateralCofinancingManager {
   ...
   * 
   * @param projectBilateralCofinancing - is the projectBilateralCofinancing object with the new information to be added/updated.
   * @return a number greater than 0 representing the new ID assigned by the database, 0 if the projectBilateralCofinancing was
   *         updated
