...
import org.cgiar.ccafs.marlo.data.manager.impl.CenterTargetUnitManager;
 ...
 */
@ImplementedBy(CenterTargetUnitManager.class)
public interface ICenterTargetUnitManager {
