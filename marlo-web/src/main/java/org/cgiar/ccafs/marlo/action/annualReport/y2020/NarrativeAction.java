...
import org.cgiar.ccafs.marlo.validation.annualreport.y2018.NarrativeValidator;
 ...
 */
public class NarrativeAction extends BaseAction {

  private static final long serialVersionUID = -8330027443050101767L;
  ...
  private ReportSynthesisNarrativeManager reportSynthesisNarrativeManager;
  ...
  @Inject
  public NarrativeAction(APConfig config, GlobalUnitManager crpManager,
    LiaisonInstitutionManager liaisonInstitutionManager, ReportSynthesisManager reportSynthesisManager,
    AuditLogManager auditLogManager, UserManager userManager, CrpProgramManager crpProgramManager,
    ReportSynthesisNarrativeManager reportSynthesisNarrativeManager, NarrativeValidator validator) {
    super(config);
    ...
    this.reportSynthesisNarrativeManager = reportSynthesisNarrativeManager;
  ...
  public void prepare() throws Exception {
    ...
    if (this.isFlagship()) {
      ...
      if (reportSynthesisDB != null) {
        if (reportSynthesisDB.getReportSynthesisNarrative() != null) {
          pmuText = reportSynthesisDB.getReportSynthesisNarrative().getNarrative();
        }
      }
    }
    ...
    this.setBasePermission(this.getText(Permission.REPORT_SYNTHESIS_NARRATIVE_BASE_PERMISSION, params));
  }
  ...
  public String save() {
    if (this.hasPermission("canEdit")) {
      ...
      ReportSynthesisNarrative reportSynthesisNarrativeDB =
        reportSynthesisManager.getReportSynthesisById(synthesisID).getReportSynthesisNarrative();

      reportSynthesisNarrativeDB.setNarrative(reportSynthesis.getReportSynthesisNarrative().getNarrative());
      reportSynthesisNarrativeDB =
        reportSynthesisNarrativeManager.saveReportSynthesisNarrative(reportSynthesisNarrativeDB);
