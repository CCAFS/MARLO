...
public class ProjectExpectedStudiesAction extends BaseAction {
			...
			if (path.toFile().exists() && this.getCurrentUser().isAutoSave()) {
				...
				if (this.expectedStudy.getProjectExpectedStudyFlagships() != null) {
					this.expectedStudy.setFlagships(new ArrayList<>(this.expectedStudy
							...
							.filter(o -> o.isActive() && o.getPhase().getId() == phase.getId() && o.getCrpProgram()
	...
	public String save() {
		...
		if (this.hasPermission("canEdit") || user.getId().equals(this.expectedStudyDB.getCreatedBy().getId())) {
			 ...
			 * the @ProjectExpectedStudy if we want a row created in the
			 * auditlog table.
			 */
	...
	public void saveCrps(ProjectExpectedStudy projectExpectedStudy, Phase phase) {
		...
		if (projectExpectedStudy.getProjectExpectedStudyCrps() != null
			...
			List<ProjectExpectedStudyCrp> crpPrev = new ArrayList<>(projectExpectedStudy.getProjectExpectedStudyCrps()
					.stream().filter(nu -> nu.isActive() && nu.getPhase().getId() == phase.getId())
					.collect(Collectors.toList()));
