...
public class ExpectedStudiesItem<T> {
                        ...
                        if (projectExpectedStudyDB != null) {
                            ...
                            if (projectExpectedStudyInfoManager.saveProjectExpectedStudyInfo(projectExpectedStudyInfo) != null) {
                                ...
                                try {
                                    ...
                                    String originalJson = mapper.writerWithDefaultPrettyPrinter().writeValueAsString(newProjectExpectedStudy);
                                    RestApiAuditlog restApiAuditLog = new RestApiAuditlog("createExpectedStudy", "Created " + projectExpectedStudy.getId(), new Date(), projectExpectedStudy.getId(), "class org.cgiar.ccafs.marlo.data.model.ProjectExpectedStudy",
    ...
    public ResponseEntity<ProjectExpectedStudyDTO> deleteExpectedStudyById(Long id, String CGIARentityAcronym,
        ...
        if (projectExpectedStudy != null) {
            ...
            if (projectExpectedStudyInfo != null) {
                ...
                // Log Action
                RestApiAuditlog restApiAuditLog = new RestApiAuditlog("deleteExpectedStudy", "Deleted CGIAR Entity Acronym " + CGIARentityAcronym + " ID " + projectExpectedStudy.getId() + " Year:" + repoYear + " Phase: " + repoPhase, new Date(), projectExpectedStudy.getId(), "class org.cgiar.ccafs.marlo.data.model.ProjectExpectedStudy",
    ...
    public List<ProjectExpectedStudiesARDTO> findAllExpectedStudyByGlobalUnit(String CGIARentityAcronym, Integer repoYear,
        ...
        // Log Action
        RestApiAuditlog restApiAuditLog = new RestApiAuditlog("findExpectedStudyByGlobalUnit", "Searched CGIAR Entity Acronym" + CGIARentityAcronym + " Year:" + repoYear + " Phase: " + repoPhase, new Date(), 0L, "class org.cgiar.ccafs.marlo.data.model.ProjectExpectedStudy",
                "N/A", user.getId(), null, "", phase.getId());
        restApiAuditlogManager.logApiCall(restApiAuditLog);
    ...
    public ResponseEntity<ProjectExpectedStudyDTO> findExpectedStudyById(Long id, String CGIARentityAcronym,
        ...
        // Log Action
            RestApiAuditlog restApiAuditLog = new RestApiAuditlog("findExpectedStudyById", "Searched CGIAR Entity Acronym" + CGIARentityAcronym + " ID " + id + "Year:" + repoYear + " Phase: " + repoPhase, new Date(), id, "class org.cgiar.ccafs.marlo.data.model.ProjectExpectedStudy",
                    "N/A", user.getId(), null, "", phase.getId());
            restApiAuditlogManager.logApiCall(restApiAuditLog);
                            ...
                            for (ProjectPolicy projectPolicy : projectPolicyList) {
                                ...
                                if (projectExpectedStudyPolicy != null) {
                                    ...
                                    try {
                                        ObjectMapper mapper = new ObjectMapper();
                                        String originalJson = mapper.writerWithDefaultPrettyPrinter().writeValueAsString(newProjectExpectedStudy);
                                        RestApiAuditlog restApiAuditLog = new RestApiAuditlog("updateExpectedStudy", "Updated " + projectExpectedStudy.getId(), new Date(), projectExpectedStudy.getId(), "class org.cgiar.ccafs.marlo.data.model.ProjectExpectedStudy",
                                                originalJson, user.getId(), null, "", phase.getId());
                                        restApiAuditlogManager.logApiCall(restApiAuditLog);
                                    } catch (Throwable ex) {
                                        Logger.getLogger(ExpectedStudiesItem.class.getName()).log(Level.SEVERE, null, ex);
