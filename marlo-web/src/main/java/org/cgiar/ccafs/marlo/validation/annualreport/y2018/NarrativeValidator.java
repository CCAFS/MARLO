 ...
 */
@Named
public class NarrativeValidator extends BaseValidator {

  private final GlobalUnitManager crpManager;
  private final ReportSynthesisManager reportSynthesisManager;

  public NarrativeValidator(GlobalUnitManager crpManager, ReportSynthesisManager reportSynthesisManager) {
  ...
  private Path getAutoSaveFilePath(ReportSynthesis reportSynthesis, long crpID, BaseAction baseAction) {
    ...
    String actionFile = ReportSynthesis2018SectionStatusEnum.NARRATIVE.getStatus().replace("/", "_");
    String autoSaveFile =
  ...
  public void validate(BaseAction action, ReportSynthesis reportSynthesis, boolean saving) {
    ...
    if (reportSynthesis != null) {
      ...
      this.saveMissingFields(reportSynthesis, action.getActualPhase().getDescription(),
        ...
        ReportSynthesis2018SectionStatusEnum.NARRATIVE.getStatus(), action);
    }
