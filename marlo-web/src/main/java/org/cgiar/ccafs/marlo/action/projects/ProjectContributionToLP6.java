 ...
 */
public class ProjectContributionToLP6 extends BaseAction {


  private static final long serialVersionUID = -793652591843623397L;


  private static final Logger LOG = LoggerFactory.getLogger(ProjectContributionToLP6.class);
  ...
  private String providingPathways;
  ...
  private String initiativeRelated;
  ...
  @Inject
  public ProjectContributionToLP6(APConfig config, ProjectManager projectManager, GlobalUnitManager crpManager,
  ...
  public String getInitiativeRelated() {
  ...
  public String getProvidingPathways() {
  ...
  public void setInitiativeRelated(String initiativeRelated) {
  ...
  public void setProvidingPathways(String providingPathways) {
