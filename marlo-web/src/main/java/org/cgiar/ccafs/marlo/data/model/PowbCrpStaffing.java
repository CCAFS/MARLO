 ...
 */
public class PowbCrpStaffing implements java.io.Serializable, IAuditLog {
  ...
  public String toString() {
    return "PowbCrpStaffing [id=" + id + ", powbSynthesis=" + powbSynthesis + ", staffingIssues=" + staffingIssues
      + "]";
  }
