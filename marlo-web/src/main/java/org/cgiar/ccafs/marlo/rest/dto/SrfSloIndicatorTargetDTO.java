...
public class SrfSloIndicatorTargetDTO {
  ...
  @ApiModelProperty(notes = "SLO indicator of target indicator")
  private SrfSloIndicatorDTO srfSloDTO;
  ...
  public SrfSloIndicatorDTO getSrfSloDTO() {
  ...
  public void setSrfSloDTO(SrfSloIndicatorDTO srfSloDTO) {
