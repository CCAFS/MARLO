 ...
 */
public class DeliverableGeographicScope extends MarloBaseEntity implements java.io.Serializable, IAuditLog {
  ...
  public boolean equals(Object obj) {
    ...
    DeliverableGeographicScope other = (DeliverableGeographicScope) obj;
    if (this.getId() == null) {
      if (other.getId() != null) {
        return false;
      }
