...
import org.cgiar.ccafs.marlo.data.dao.mysql.FundingSourceInfoMySQLDAO;
...
@ImplementedBy(FundingSourceInfoMySQLDAO.class)
public interface FundingSourceInfoDAO {
