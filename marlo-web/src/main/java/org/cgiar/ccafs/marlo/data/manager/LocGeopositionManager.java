...
import org.cgiar.ccafs.marlo.data.manager.impl.LocGeopositionManagerImpl;
 ...
 */
@ImplementedBy(LocGeopositionManagerImpl.class)
public interface LocGeopositionManager {
