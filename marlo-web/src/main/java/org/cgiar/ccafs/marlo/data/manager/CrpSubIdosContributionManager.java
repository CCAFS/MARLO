...
import org.cgiar.ccafs.marlo.data.manager.impl.CrpSubIdosContributionManagerImpl;
 ...
 */
@ImplementedBy(CrpSubIdosContributionManagerImpl.class)
public interface CrpSubIdosContributionManager {
   ...
   * @return a number greater than 0 representing the new ID assigned by the database, 0 if the crpSubIdosContribution was
   *         updated
