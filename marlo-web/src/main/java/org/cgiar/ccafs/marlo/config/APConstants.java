...
public final class APConstants {
  ...
  // Types of project
  public static final String PROJECT_CORE = "{0}_CORE";
  public static final String PROJECT_CCAFS_COFUNDED = "{0}_COFUNDED";
  public static final String PROJECT_BILATERAL = "{0}_BILATERAL";
