 ...
 */
public class ControlIndicatorAction extends BaseAction {

  private static final long serialVersionUID = -8306463804965610803L;

  private static Logger LOG = LoggerFactory.getLogger(ControlIndicatorAction.class);
  ...
  @Inject
  public ControlIndicatorAction(APConfig config, GlobalUnitManager crpManager,
