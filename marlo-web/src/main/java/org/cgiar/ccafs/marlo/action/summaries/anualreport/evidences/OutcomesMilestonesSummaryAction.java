 ...
 */
public class OutcomesMilestonesSummaryAction extends BaseSummariesAction implements Summary {


  private static final long serialVersionUID = -2543743013961311798L;
  private static Logger LOG = LoggerFactory.getLogger(OutcomesMilestonesSummaryAction.class);
  // Managers
