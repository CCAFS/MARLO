 ...
 */
public class MOGSynthesisReportingSummaryAction extends BaseSummariesAction implements Summary {
  ...
  @Inject
  public MOGSynthesisReportingSummaryAction(APConfig config, GlobalUnitManager crpManager, PhaseManager phaseManager) {
