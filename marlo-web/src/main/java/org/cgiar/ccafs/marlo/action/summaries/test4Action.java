 ...
 */
public class test4Action extends BaseAction implements Summary {

  private static final long serialVersionUID = -624982650510682813L;
  private static Logger LOG = LoggerFactory.getLogger(test4Action.class);
  ...
  @Inject
  public test4Action(APConfig config, CrpManager crpManager, ProjectManager projectManager,
  ...
  public String execute() throws Exception {
    ...
    try {
      Resource reportResource =
        manager.createDirectly(this.getClass().getResource("/pentaho/Pruebautf8HtmlEmbeed.prpt"), MasterReport.class);
