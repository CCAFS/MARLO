...
import org.cgiar.ccafs.marlo.data.manager.impl.ProjectHighligthTypeManagerImpl;
 ...
 */
@ImplementedBy(ProjectHighligthTypeManagerImpl.class)
public interface ProjectHighligthTypeManager {
