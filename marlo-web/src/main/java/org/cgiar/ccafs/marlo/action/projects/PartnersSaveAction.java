...
public class PartnersSaveAction extends BaseAction {
    ...
    public String save() {
        ...
        if (isAiccra()) {
            ...
            request.put("externalUserMail", getCurrentUser().getEmail());
            request.put("externalUserName", getCurrentUser().getUsername());
            ...
            try {
                ...
                String responseStr = epu.postJson(config.getClarisaAPIHost() + "/api/CCAFS/institutions/institution-requests", requestStr);
