...
public class TWsMarloAgree  implements java.io.Serializable {
    ...
    public TWsMarloAgree(
           ...
           java.lang.String donor,
           java.lang.String donorText,
           java.lang.String endDate,
           java.lang.String extentionDate,
           java.lang.String fundingType,
           java.lang.Double grantAmount,
           java.lang.String objectives,
           java.lang.String researcher,
           java.lang.String researcherText,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TWsMarloAgree)) return false;
        ...
        _equals = true && 
            ...
            ((this.donorText==null && other.getDonorText()==null) || 
             (this.donorText!=null &&
              this.donorText.equals(other.getDonorText()))) &&
            ((this.endDate==null && other.getEndDate()==null) || 
             (this.endDate!=null &&
              this.endDate.equals(other.getEndDate()))) &&
            ((this.extentionDate==null && other.getExtentionDate()==null) || 
             (this.extentionDate!=null &&
              this.extentionDate.equals(other.getExtentionDate()))) &&
            ...
            ((this.grantAmount==null && other.getGrantAmount()==null) || 
             (this.grantAmount!=null &&
              this.grantAmount.equals(other.getGrantAmount()))) &&
            ...
            ((this.researcher==null && other.getResearcher()==null) || 
             (this.researcher!=null &&
              this.researcher.equals(other.getResearcher()))) &&
            ((this.researcherText==null && other.getResearcherText()==null) || 
             (this.researcherText!=null &&
              this.researcherText.equals(other.getResearcherText()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getDonorText() != null) {
            _hashCode += getDonorText().hashCode();
        }
        if (getEndDate() != null) {
            _hashCode += getEndDate().hashCode();
        }
        if (getExtentionDate() != null) {
            _hashCode += getExtentionDate().hashCode();
        }
        if (getFundingType() != null) {
            _hashCode += getFundingType().hashCode();
        }
        if (getGrantAmount() != null) {
            _hashCode += getGrantAmount().hashCode();
        }
        if (getObjectives() != null) {
            _hashCode += getObjectives().hashCode();
        }
        if (getResearcher() != null) {
            _hashCode += getResearcher().hashCode();
        }
        if (getResearcherText() != null) {
            _hashCode += getResearcherText().hashCode();
        }
