 ...
 */
@Named
public class EfficiencyValidator extends BaseValidator {

  private final GlobalUnitManager crpManager;
  private final ReportSynthesisManager reportSynthesisManager;

  public EfficiencyValidator(GlobalUnitManager crpManager, ReportSynthesisManager reportSynthesisManager) {
  ...
  private Path getAutoSaveFilePath(ReportSynthesis reportSynthesis, long crpID, BaseAction baseAction) {
    ...
    String actionFile = ReportSynthesisSectionStatusEnum.EFFICIENCY.getStatus().replace("/", "_");
    String autoSaveFile =
  ...
  public void validate(BaseAction action, ReportSynthesis reportSynthesis, boolean saving) {
    ...
    if (reportSynthesis != null) {
      ...
      if (!this.isValidString(reportSynthesis.getReportSynthesisEfficiency().getDescription())) {
        action.addMessage(action.getText("annualReport.efficiency.successes.readText"));
      ...
      this.saveMissingFields(reportSynthesis, action.getActualPhase().getDescription(),
        action.getActualPhase().getYear(), ReportSynthesisSectionStatusEnum.EFFICIENCY.getStatus(), action);
    }
