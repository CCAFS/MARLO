...
public class CrpActivityAction extends BaseAction {
  ...
  @Inject
  public CrpActivityAction(APConfig config, RoleManager roleManager, UserRoleManager userRoleManager,
    ...
    CrpUserManager crpUserManager, ParameterManager parameterManager, ActivityTitleManager activityTitleManager) {
    super(config);
