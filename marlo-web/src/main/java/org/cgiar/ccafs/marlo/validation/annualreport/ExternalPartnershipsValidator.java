 ...
 */
@Named
public class ExternalPartnershipsValidator extends BaseValidator {

  private final GlobalUnitManager crpManager;
  private final ReportSynthesisManager reportSynthesisManager;

  public ExternalPartnershipsValidator(GlobalUnitManager crpManager, ReportSynthesisManager reportSynthesisManager) {
  ...
  public void validate(BaseAction action, ReportSynthesis reportSynthesis, boolean saving) {
    ...
    if (reportSynthesis != null) {
      ...
      // Validate Highlights
      if (!this.isValidString(reportSynthesis.getReportSynthesisExternalPartnership().getHighlights())) {
        action.addMessage(action.getText("reportSynthesis.reportSynthesisExternalPartnership.highlights"));
        action.getInvalidFields().put("input-reportSynthesis.reportSynthesisExternalPartnership.highlights",
