 ...
 */
public class test1Action extends BaseAction implements Summary {

  private static final long serialVersionUID = -624982650510682813L;
  private static Logger LOG = LoggerFactory.getLogger(test1Action.class);
  ...
  @Inject
  public test1Action(APConfig config, CrpManager crpManager, ProjectManager projectManager,
  ...
  public String execute() throws Exception {
    ...
    try {
      Resource reportResource =
        manager.createDirectly(this.getClass().getResource("/pentaho/PruebaISO-8859-1Html.prpt"), MasterReport.class);
