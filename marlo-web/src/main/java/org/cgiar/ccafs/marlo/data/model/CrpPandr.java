 ...
 */
public class CrpPandr extends MarloSoftDeleteableEntity implements java.io.Serializable, IAuditLog {
  ...
  public String toString() {
    return "CrpPandr [id=" + this.getId() + ", name=" + name + ", acronym=" + acronym + "]";
  }
