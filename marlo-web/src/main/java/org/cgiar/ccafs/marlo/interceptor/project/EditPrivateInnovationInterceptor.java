 ...
 */
public class EditPrivateInnovationInterceptor extends AbstractInterceptor implements Serializable {
  ...
  @Inject
  public EditPrivateInnovationInterceptor(ProjectInnovationManager projectInnovationManager,
  ...
  void setPermissionParameters(ActionInvocation invocation) throws Exception {
    ...
    ProjectInnovation projectInnovation = projectInnovationManager.getProjectInnovationById(expectedId);
    GlobalUnit unit = null;
    if (projectInnovation.getProject() != null) {
      Project project = projectInnovation.getProject();
