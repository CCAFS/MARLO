...
import org.cgiar.ccafs.marlo.data.dao.mysql.DeliverableDataSharingMySQLDAO;
...
@ImplementedBy(DeliverableDataSharingMySQLDAO.class)
public interface DeliverableDataSharingDAO {
   ...
   * @return a number greater than 0 representing the new ID assigned by the database, 0 if the deliverableDataSharing was
   *         updated
