 ...
 */
public class CrpUser extends MarloAuditableEntity implements java.io.Serializable, IAuditLog {
  ...
  public CrpUser(GlobalUnit crps, User users) {
    this.crp = crps;
    this.user = users;
  }
  ...
  public String toString() {
    return "CrpUser [id=" + this.getId() + ", crp=" + crp + ", user=" + user + "]";
  }
