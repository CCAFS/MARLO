...
import org.cgiar.ccafs.marlo.data.dao.mysql.ProjectCrpContributionMySQLDAO;
...
@ImplementedBy(ProjectCrpContributionMySQLDAO.class)
public interface ProjectCrpContributionDAO {
