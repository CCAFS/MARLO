[#ftl]
  ...
  [#attempt]
  [#assign submission = (action.isSubmitProject(projectID))! /]
      ...
      <li>
        <ul><p class="menuTitle">${menu.title}</p>
          [#list menu.items as item]
            [#if (item.show)!true ]
            [#assign submitStatus = (action.getSectionStatusProject(item.action, projectID))!false /]
...
[#-- program Submit JS --]
[#assign customJS = [ "${baseUrl}/js/monitoring/projects/projectSubmit.js" ] + customJS  /]
