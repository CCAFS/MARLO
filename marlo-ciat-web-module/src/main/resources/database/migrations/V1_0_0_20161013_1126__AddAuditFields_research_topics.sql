...
ALTER TABLE `research_topics` ADD CONSTRAINT `fk_rtropic_created_by` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`);

ALTER TABLE `research_topics` ADD CONSTRAINT `fk_rtropic_modified_by` FOREIGN KEY (`modified_by`) REFERENCES `users` (`id`);