...
CREATE TABLE `beneficiaries` (
  ...
  CONSTRAINT `beneficiaries_ibfk_2` FOREIGN KEY (`modified_by`) REFERENCES `users` (`id`),
  CONSTRAINT `beneficiaries_ibfk_3` FOREIGN KEY (`beneficiary_type_id`) REFERENCES `beneficiary_types` (`id`)
...
INSERT INTO `beneficiaries` VALUES ('16', 'Peri-Urban', '2', '1', '2017-05-03 14:26:49', '3', '3', '  ');
...
INSERT INTO `beneficiaries` VALUES ('21', 'Non Specific', '1', '1', '2017-05-03 14:26:18', '3', '3', ' ');
INSERT INTO `beneficiaries` VALUES ('22', 'Non Specific', '2', '1', '2017-05-03 14:26:51', '3', '3', ' ');
INSERT INTO `beneficiaries` VALUES ('23', 'Ecosystems', '3', '1', '2017-05-03 14:27:22', '3', '3', ' ');
INSERT INTO `beneficiaries` VALUES ('24', 'Non Specific', '3', '1', '2017-05-03 14:27:33', '3', '3', ' ');
