...
import org.cgiar.ccafs.marlo.data.service.impl.SrfIdoService;
 ...
 */
@ImplementedBy(SrfIdoService.class)
public interface ISrfIdoService {
  ...
  /**
   * This method gets a list of srfIdos belongs of the user
   * 
   * @param userId - the user id
   * @return List of SrfIdos or null if the user is invalid or not have roles.
   */
