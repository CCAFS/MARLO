 ...
 */
public class CenterProgramService implements ICenterProgramService {
  ...
  @Inject
  public CenterProgramService(ICenterProgramDAO crpProgramDAO) {
  ...
  /*
   * (non-Javadoc)
   * @see org.cgiar.ccafs.marlo.data.service.ICenterProgramService#findProgramsByResearchArea(java.lang.Long)
   */
  @Override
