 ...
 */
public class CenterSectionStatusService implements ICenterSectionStatusService {
  ...
  @Inject
  public CenterSectionStatusService(ICenterSectionStatusDAO sectionStatusDAO) {
