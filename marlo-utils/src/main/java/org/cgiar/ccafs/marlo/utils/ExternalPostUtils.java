...
public class ExternalPostUtils {
    ...
    public String postJson(String endpoint, String parameters) {
        return makeRequest(endpoint, "application/json", parameters);
    }
    
    private String makeRequest(String method, String contentType, String parameters) {
        if (method.startsWith("https://")) {
            return makeSecureRequest(method, contentType, parameters);
        } else {
            return makeUnsecureRequest(method, contentType, parameters);
        }
    }
    ...
    private String makeSecureRequest(String endpoint, String contentType, String parameters) {
        ...
        try {
            ...
            connection.setRequestProperty("Content-Type", contentType.isEmpty()
...
//            }
            ...
            if (connection.getResponseCode() >= 200 && connection.getResponseCode() < 300) {
                ...
                System.out.println(requestMethod + " request to " + endpoint + " generated response " + connection.getResponseCode() + " " + connection.getResponseMessage() + " " + requestMethod + "ing\n" + parameters);
