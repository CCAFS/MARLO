...
public class ProjectedBenefitsWeightDescriptionManagerImpl implements ProjectedBenefitsWeightDescriptionManager {
  ...
  public ProjectedBenefitsWeightDescriptionManagerImpl(
    ...
    super();
    this.projectedBenefitsWeightDescriptionDAO = projectedBenefitsWeightDescriptionDAO;
  }

  @Override
  public ProjectedBenefitsWeightDescription find(long id) {
    return projectedBenefitsWeightDescriptionDAO.find(id);
  }

  @Override
  public List<ProjectedBenefitsWeightDescription> findAll() {
    return projectedBenefitsWeightDescriptionDAO.findAll();
  }
