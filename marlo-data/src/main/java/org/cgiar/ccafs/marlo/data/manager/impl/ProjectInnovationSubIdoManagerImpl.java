...
public class ProjectInnovationSubIdoManagerImpl implements ProjectInnovationSubIdoManager {
  ...
  @Inject
  public ProjectInnovationSubIdoManagerImpl(ProjectInnovationSubIdoDAO projectInnovationSubIdoDAO, PhaseDAO phaseDAO) {
  ...
  public void deleteProjectInnovationSubIdo(long projectInnovationSubIdoId) {
    ProjectInnovationSubIdo ProjectInnovationSubIdo = this.getProjectInnovationSubIdoById(projectInnovationSubIdoId);
    ...
    if (ProjectInnovationSubIdo.getPhase().getDescription().equals(APConstants.REPORTING)) {
      if (ProjectInnovationSubIdo.getPhase().getNext() != null
        ...
        if (upkeepPhase != null) {
          this.deleteProjectInnovationSubIdoPhase(upkeepPhase, ProjectInnovationSubIdo.getProjectInnovation().getId(),
  ...
  public ProjectInnovationSubIdo getProjectInnovationSubIdoByPhase(Long innovationID, Long subIdoID, Long phaseID) {
    ...
    return projectInnovationSubIdoDAO.getProjectInnovationSubIdoByPhase(innovationID, subIdoID, phaseID);
  }
  ...
  public void saveInnovationMilestonePhase(Phase next, long innovationid,
    ...
    List<ProjectInnovationSubIdo> projectInnovatioCenters =
      projectInnovationSubIdoDAO.findAll().stream()
