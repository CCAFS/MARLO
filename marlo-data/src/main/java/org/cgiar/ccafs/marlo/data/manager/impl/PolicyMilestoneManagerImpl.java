...
public class PolicyMilestoneManagerImpl implements PolicyMilestoneManager {
	...
	if (policyMilestone.getPhase().getDescription().equals(APConstants.REPORTING)) {
	    if (policyMilestone.getPhase().getNext() != null
		    && policyMilestone.getPhase().getNext().getNext() != null) {
	...
	if (phase.getDescription().equals(APConstants.PLANNING) && phase.getNext() != null) {
	    this.savePolicyMilestonePhase(pMilestone.getPhase().getNext(), pMilestone.getPolicy().getId(),
		    policyMilestone);
	}
