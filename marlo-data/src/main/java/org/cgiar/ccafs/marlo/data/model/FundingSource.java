 ...
 */
public class FundingSource extends MarloAuditableEntity implements java.io.Serializable, IAuditLog {
  ...
  public String getComposedName() {
    try {
      ...
      return "<b> (FS" + this.getId() + ") " + this.getFundingSourceInfo().getBudgetType().getName() + "</b> - "
        + this.getFundingSourceInfo().getTitle();
    } catch (Exception e) {
      return "<b> (FS" + this.getId() + ") </b> - " + this.getFundingSourceInfo().getTitle();
    }
  }
