...
@Named
public class ProjectExpectedStudyGlobalTargetMySQLDAO extends AbstractMarloDAO<ProjectExpectedStudyGlobalTarget, Long> implements ProjectExpectedStudyGlobalTargetDAO {
