...
import org.cgiar.ccafs.marlo.data.manager.impl.LocElementTypeManagerImpl;
 ...
 */
@ImplementedBy(LocElementTypeManagerImpl.class)
public interface LocElementTypeManager {
