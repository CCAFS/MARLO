...
public interface ProjectInnovationCenterDAO {
   ...
   * 
   * @param projectInnovationCenter - is the projectInnovationCenter object with the new information to be
   *        added/updated.
   * @return a number greater than 0 representing the new ID assigned by the database, 0 if the projectInnovationCenter
   *         was
   *         updated
