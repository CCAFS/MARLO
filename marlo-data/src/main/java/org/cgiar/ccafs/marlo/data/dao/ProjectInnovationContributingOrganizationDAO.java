...
public interface ProjectInnovationContributingOrganizationDAO {
    ...
    /**
     * This method removes a specific projectInnovationContributingOrganization
     * value from the database.
     * 
     * @param projectInnovationContributingOrganizationId is the
     *                                                    projectInnovationContributingOrganization
     *                                                    identifier.
     * @return true if the projectInnovationContributingOrganization was
     *         successfully deleted, false otherwise.
     */
    public void deleteProjectInnovationContributingOrganization(long projectInnovationContributingOrganizationId);

    /**
     * This method validate if the projectInnovationContributingOrganization
     * identify with the given id exists in the
     * system.
     * 
     * @param projectInnovationContributingOrganizationID is a
     *                                                    projectInnovationContributingOrganization
     *                                                    identifier.
     * @return true if the projectInnovationContributingOrganization exists, false
     *         otherwise.
     */
    public boolean existProjectInnovationContributingOrganization(long projectInnovationContributingOrganizationID);

    /**
     * This method gets a projectInnovationContributingOrganization object by a
     * given
    ...
    /**
     * This method gets a list of projectInnovationContributingOrganization that are
     * active
     * 
     * @return a list from ProjectInnovationContributingOrganization null if no
     *         exist records
     */
    public List<ProjectInnovationContributingOrganization> findAll();

    public ProjectInnovationContributingOrganization getProjectInnovationContributingOrganization(
     ...
     * projectInnovationContributingOrganization
     * 
     * @param projectInnovationContributingOrganization - is the
     *                                                  projectInnovationContributingOrganization
     *                                                  object with the
    ...
    /**
     * This method gets a list of projectInnovationContributingOrganization by
     * innovation and institution and phase.
     * 
     * @param innovationId  is the innovation identifier.
     * @param institutionId is the institution identifier.
     * @param phaseId       is the phase identifier.
     * @return a list of projectInnovationContributingOrganization.
     */
