...
import org.cgiar.ccafs.marlo.data.manager.impl.CrpIndicatorManagerImpl;
 ...
 */
@ImplementedBy(CrpIndicatorManagerImpl.class)
public interface CrpIndicatorManager {
   ...
   */
  public long saveCrpIndicator(CrpIndicator crpIndicator);
