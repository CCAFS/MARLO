...
public class ProjectExpectedStudyAllianceLeversOutcome extends MarloAuditableEntity
  ...
  @Expose
  private AllianceLeverOutcome allianceLeverOutcome;
  ...
  public boolean equals(Object obj) {
    ...
    ProjectExpectedStudyAllianceLeversOutcome other = (ProjectExpectedStudyAllianceLeversOutcome) obj;
    if (this.getId() == null) {
      if (other.getId() != null) {
        return false;
      }
  ...
  public AllianceLeverOutcome getAllianceLeverOutcome() {
  ...
  public void setAllianceLeverOutcome(AllianceLeverOutcome allianceLeverOutcome) {
    this.allianceLeverOutcome = allianceLeverOutcome;
  }
