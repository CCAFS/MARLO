...
public class Phase extends MarloBaseEntity implements java.io.Serializable, IAuditLog {
  ...
  private Set<CrpProgramOutcomeIndicator> programOutcomeIndicators = new HashSet<CrpProgramOutcomeIndicator>(0);
  ...
  private Set<ProjectExpectedStudySdgAllianceLever> projectExpectedStudySdgAllianceLevers =
  ...
  private Set<ProjectInnovationPartnership> projectInnovationPartnerships =
    new HashSet<ProjectInnovationPartnership>(0);

  private Set<ProjectExpectedStudyImpactArea> projectExpectedStudyImpactAreas =
    new HashSet<ProjectExpectedStudyImpactArea>(0);
  private Set<ProjectExpectedStudyGlobalTarget> projectExpectedStudyGlobalTargets =
    new HashSet<ProjectExpectedStudyGlobalTarget>(0);
  ...
  public void setProgramOutcomeIndicators(Set<CrpProgramOutcomeIndicator> programOutcomeIndicators) {
    this.programOutcomeIndicators = programOutcomeIndicators;
  }
