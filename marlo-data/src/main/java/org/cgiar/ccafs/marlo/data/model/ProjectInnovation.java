...
public class ProjectInnovation extends MarloAuditableEntity implements java.io.Serializable, IAuditLog {
	...
	private Set<ProjectInnovationContributingOrganization> projectInnovationContributingOrganization = new HashSet<ProjectInnovationContributingOrganization>(
			0);

	private Set<ProjectInnovationOrganization> projectInnovationOrganizations = new HashSet<ProjectInnovationOrganization>(
			0);

	private Set<ProjectInnovationDeliverable> projectInnovationDeliverables = new HashSet<ProjectInnovationDeliverable>(
			0);
	...
	private Set<ProjectInnovationGeographicScope> projectInnovationGeographicScopes = new HashSet<ProjectInnovationGeographicScope>(
			0);
	...
	public ProjectInnovationInfo getProjectInnovationInfo(Phase phase) {
		if (this.getProjectInnovationInfo() != null) {
			...
			List<ProjectInnovationInfo> infos = this.projectInnovationInfos.stream()
					.filter(c -> c != null && c.getPhase() != null && c.getPhase().getId() != null
							&& c.getPhase().getId().longValue() == phase.getId())
	...
	public void setContributingOrganizations(
			List<ProjectInnovationContributingOrganization> contributingOrganizations) {
	...
	public void setProjectInnovationGeographicScopes(
			Set<ProjectInnovationGeographicScope> projectInnovationGeographicScopes) {
