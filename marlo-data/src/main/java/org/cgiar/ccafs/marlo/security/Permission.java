...
public class Permission {
  ...
  public static final String PROJECT_ALL_EDITION = "crp:{0}:project:{1}:*";
  ...
  public static final String REPORT_SYNTHESIS_SUBMIT_PERMISSION = "crp:{0}:reportSynthesis:{1}:submit";
