...
public interface AllianceLeverOutcomeManager {
   ...
   * 
   * @return a list from AllianceAllianceLeverOutcome null if no exist records
   */
   ...
   * 
   * @param allianceLeverOutcomeID is the allianceLeverOutcome identifier.
   * @return a AllianceAllianceLeverOutcome object.
   */
