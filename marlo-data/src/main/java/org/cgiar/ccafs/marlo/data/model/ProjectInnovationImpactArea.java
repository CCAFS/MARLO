...
public class ProjectInnovationImpactArea extends MarloAuditableEntity implements java.io.Serializable, IAuditLog {
  ...
  public boolean equals(Object obj) {
    ...
    ProjectInnovationImpactArea other = (ProjectInnovationImpactArea) obj;
    if (this.getId() == null) {
      if (other.getId() != null) {
        return false;
      }
  ...
  public String toString() {
    return "ProjectExpectedStudyImpactArea [projectInnovation=" + projectInnovation + ", phase=" + phase
