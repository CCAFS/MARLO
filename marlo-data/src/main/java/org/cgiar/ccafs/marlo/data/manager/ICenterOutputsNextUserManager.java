...
import org.cgiar.ccafs.marlo.data.manager.impl.CenterOutputsNextUserManager;
 ...
 */
@ImplementedBy(CenterOutputsNextUserManager.class)
public interface ICenterOutputsNextUserManager {
   ...
   * 
   * @param researchOutputsNextUser - is the researchOutputsNextUser object with the new information to be
   *        added/updated.
   * @return a number greater than 0 representing the new ID assigned by the database, 0 if the researchOutputsNextUser
   *         was
   *         updated
