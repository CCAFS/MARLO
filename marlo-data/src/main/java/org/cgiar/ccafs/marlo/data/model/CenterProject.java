 ...
 */
public class CenterProject extends MarloAuditableEntity implements java.io.Serializable, IAuditLog {
  ...
  public String getComposedName() {
    return "P" + this.getId() + "- " + (this.name != null ? this.name : "title not defined");
  }
  ...
  public String toString() {
    return "CenterProject [id=" + this.getId() + "]";
  }
