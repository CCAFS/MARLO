 ...
 */
public class FundingSourceDivision extends MarloBaseEntity implements java.io.Serializable, IAuditLog {
  ...
  public boolean equals(Object obj) {
    ...
    FundingSourceDivision other = (FundingSourceDivision) obj;
    if (this.getId() == null) {
      if (other.getId() != null) {
        return false;
      }
  ...
  public String toString() {
    return "FundingSourceInstitution [id=" + this.getId() + ", fundingSource=" + fundingSource + ", division="
      + division + "]";
  }
