...
public interface GeneralAcronymDAO {
  ...
  /**
   * This method gets a list of generalAcronym that are active and match with the acronym given
   * 
   * @return a list from GeneralAcronym null if no exist records
   */
  List<GeneralAcronym> findByAcronym(String acronym);
