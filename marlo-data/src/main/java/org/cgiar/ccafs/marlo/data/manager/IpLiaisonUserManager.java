...
import org.cgiar.ccafs.marlo.data.manager.impl.IpLiaisonUserManagerImpl;
 ...
 */
@ImplementedBy(IpLiaisonUserManagerImpl.class)
public interface IpLiaisonUserManager {
