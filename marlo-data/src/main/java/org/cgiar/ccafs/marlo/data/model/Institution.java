...
public class Institution extends MarloBaseEntity implements java.io.Serializable, IAuditLog {
	...
	/*
	 * public String getComposedLocation() { try { if (this.headquarter == null)
	 * { // Verify if there exist a city to show if (this.city != null &&
	 * this.city != "") { return this.city + ", " + this.locElement.getName(); }
	 * return this.locElement.getName(); } else { // Verify if there exist a
	 * city to show if (this.city != null && this.city != "") { return this.city
	 * + ", " + this.locElement.getName(); } return this.locElement.getName(); }
	 * } catch (Exception e) { return this.name; } }
	 */
	...
	public String toString() {
		return "Institution [id=" + this.getId() + ", institutionType=" + institutionType + ", name=" + name
				+ ", acronym=" + acronym + ", programId=" + programId + "]";
	}
}
