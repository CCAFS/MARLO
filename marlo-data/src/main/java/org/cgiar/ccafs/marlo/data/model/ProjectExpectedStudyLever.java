...
public class ProjectExpectedStudyLever extends MarloBaseEntity implements java.io.Serializable, IAuditLog {
  ...
  public void copyFields(ProjectExpectedStudyLever other) {
    this.setAllianceLever(other.getAllianceLever());
  ...
  public boolean equals(Object obj) {
    ...
    ProjectExpectedStudyLever other = (ProjectExpectedStudyLever) obj;
    if (this.getId() == null) {
      if (other.getId() != null) {
        return false;
      }
